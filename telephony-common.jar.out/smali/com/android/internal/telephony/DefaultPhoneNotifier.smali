...
# virtual methods
.method public broadcastCallStateChangedWithoutNotify(Lcom/android/internal/telephony/Phone;I)V
    .locals 4
    .param p1, "sender"    # Lcom/android/internal/telephony/Phone;
    .param p2, "subId"    # I
    ...
    invoke-interface {v2, p2, v3, v0}, Lcom/android/internal/telephony/ITelephonyRegistry;->broadcastCallStateChangedWithoutNotify(IILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updatePhoneStateExtras(Lcom/android/internal/telephony/Phone;)V
    .locals 5
    .param p1, "sender"    # Lcom/android/internal/telephony/Phone;
    ...
    invoke-interface {p1}, Lcom/android/internal/telephony/Phone;->getRadioInPhoneState()Ljava/lang/String;

    move-result-object v2

    invoke-interface {p1}, Lcom/android/internal/telephony/Phone;->getCallTypeInPhoneState()Ljava/lang/String;

    move-result-object v3

    invoke-interface {p1}, Lcom/android/internal/telephony/Phone;->getReasonInPhoneState()Ljava/lang/String;

    move-result-object v4

    invoke-interface {v1, v0, v2, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry;->updatePhoneStateExtras(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
