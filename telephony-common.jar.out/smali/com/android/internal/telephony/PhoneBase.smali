...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    iput-boolean v14, v0, Lcom/android/internal/telephony/PhoneBase;->mStkRefreshSimrest:Z
    ...
    const-string v14, "ril.voicecapable"

    move-object/from16 v0, p0

    iget-boolean v15, v0, Lcom/android/internal/telephony/PhoneBase;->mIsVoiceCapable:Z
...
.method public broadcastCallStateChangedWithoutNotify(I)V
    .locals 1
    .param p1, "subId"    # I
    ...
    invoke-interface {v0, p0, p1}, Lcom/android/internal/telephony/PhoneNotifier;->broadcastCallStateChangedWithoutNotify(Lcom/android/internal/telephony/Phone;I)V
...
.method public getCallTypeInPhoneState()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/CallTracker;->getCallTypeInPhoneState()Ljava/lang/String;
...
.method public getRadioInPhoneState()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/CallTracker;->getRadioInPhoneState()Ljava/lang/String;
...
.method public getReasonInPhoneState()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/CallTracker;->getReasonInPhoneState()Ljava/lang/String;
...
.method public notifyNewRingingConnectionP(Lcom/android/internal/telephony/Connection;)V
    ...
    const-string v2, "Softphone Ignore VoiceCapable"
...
.method public setPcoValue(I)V
    ...
    const-string v7, "Waiting for property setting ("
    ...
    invoke-virtual {v5, v6}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->cleanUpAllConnections(Ljava/lang/String;)V

    iget-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mDcTracker:Lcom/android/internal/telephony/dataconnection/DcTrackerBase;

    invoke-virtual {v5}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->isDisconnected()Z
    ...
    iget v5, p0, Lcom/android/internal/telephony/PhoneBase;->mPendingTurnOffRadioAfterDataOffTag:I

    add-int/lit8 v5, v5, 0x1

    iput v5, p0, Lcom/android/internal/telephony/PhoneBase;->mPendingTurnOffRadioAfterDataOffTag:I
    ...
    const-string v6, "Wait upto 5s for data to disconnect, then turn off radio. (by PCO)"

    invoke-static {v5, v6}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput-boolean v10, p0, Lcom/android/internal/telephony/PhoneBase;->mPendingTurnOffRadioAfterDataOff:Z

    .end local v0    # "currentPcoValue":I
    ...
    .restart local v0    # "currentPcoValue":I
    ...
    const-string v6, "Cannot send delayed Msg, turn off radio right away. (by PCO)"
    ...
    const-string v6, "setPcoValue: not possible"
...
.method public updatePhoneStateExtras()V
    .locals 1
    ...
    invoke-interface {v0, p0}, Lcom/android/internal/telephony/PhoneNotifier;->updatePhoneStateExtras(Lcom/android/internal/telephony/Phone;)V
