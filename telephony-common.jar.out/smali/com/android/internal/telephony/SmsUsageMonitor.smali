...
.method private getOpPatternMatcher(Ljava/lang/String;)Lcom/android/internal/telephony/SmsUsageMonitor$ShortCodePatternMatcher;
    ...
    :try_start_0
    iget-object v9, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mContext:Landroid/content/Context;
    ...
    invoke-interface {v8, v9, v11}, Landroid/content/res/XmlResourceParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v12, "Found country "
    ...
    .line 387
    .local v5, "op_pattern":Ljava/lang/String;
    const/4 v9, 0x0

    const-string v11, "op_premium"
    ...
    .line 388
    .local v6, "op_premium":Ljava/lang/String;
    const/4 v9, 0x0

    const-string v11, "op_free"
    ...
    .line 389
    .local v4, "op_free":Ljava/lang/String;
    const/4 v9, 0x0

    const-string v11, "op_standard"
    ...
    .line 390
    .local v7, "op_standard":Ljava/lang/String;
    new-instance v9, Lcom/android/internal/telephony/SmsUsageMonitor$ShortCodePatternMatcher;

    invoke-direct {v9, v5, v6, v4, v7}, Lcom/android/internal/telephony/SmsUsageMonitor$ShortCodePatternMatcher;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    .end local v4    # "op_free":Ljava/lang/String;
    .end local v5    # "op_pattern":Ljava/lang/String;
    .end local v6    # "op_premium":Ljava/lang/String;
    .end local v7    # "op_standard":Ljava/lang/String;
    :cond_4
    :try_start_3
    const-string v9, "SmsUsageMonitor"
    ...
    const-string v11, "XML parser exception reading short op code patterns"

    invoke-static {v9, v11, v1}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_4
    ...
    const-string v11, "I/O exception reading short op code patterns"
...
.method public checkDestination(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 488
    iget-object v4, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mSettingsObserverHandler:Lcom/android/internal/telephony/SmsUsageMonitor$SettingsObserverHandler;
    ...
    .line 495
    :cond_0
    iget-object v5, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mCheckEnabled:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v6, "CscFeature_RIL_SmsReadConfirm"
    ...
    const-string v6, "CscFeature_RIL_SmsAllowEmailsmsAddress"
    ...
    .line 518
    .local v1, "sMessageConfigImeiTracker":Ljava/lang/String;
    invoke-static {}, Lcom/sec/android/app/CscFeature;->getInstance()Lcom/sec/android/app/CscFeature;

    move-result-object v5

    const-string v6, "CscFeature_Message_ConfigImeiTracker"
    ...
    .line 525
    .end local v1    # "sMessageConfigImeiTracker":Ljava/lang/String;
    :cond_6
    if-eqz p2, :cond_9

    .line 526
    iget-object v5, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mCurrentCountry:Ljava/lang/String;
    ...
    iget-wide v8, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mPatternFileLastModified:J
    ...
    const-string v7, "CscFeature_RIL_ConfigSsms"
    ...
    const-string v6, "Loading SMS Short Code patterns from resource only"
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mCurrentPatternMatcher:Lcom/android/internal/telephony/SmsUsageMonitor$ShortCodePatternMatcher;
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mOpPatternMatcher:Lcom/android/internal/telephony/SmsUsageMonitor$ShortCodePatternMatcher;

    .line 547
    :cond_9
    iget-object v5, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mCurrentPatternMatcher:Lcom/android/internal/telephony/SmsUsageMonitor$ShortCodePatternMatcher;
    ...
    .line 557
    .restart local v0    # "numCategory":I
    :cond_e
    const-string v5, "SmsUsageMonitor"
    ...
    const-string v7, "No patterns for \""
    ...
    const-string v7, "\": using generic short code rule"
