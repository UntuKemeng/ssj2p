...
.field private static final EVENT_CARD_SWAPED:I = 0x323
...
.field private static final EVENT_GET_OPLMNWACT_DONE:I = 0x20d
...
.field private static final SUB_OPS_PATH:Ljava/lang/String; = "vendor/carrier/LRA/sub-ops.xml"
...
.field private static final VALUE_ALPHA:I = 0x1

.field private static final VALUE_NUMERIC:I = 0x0
...
.field private mGidNetworkInfoMap:Ljava/util/HashMap;
...
.field private mIsLraIdentifiersSetForSingleSku:Z
...
.field private mRecordsInterrupted:Z
...
.method public constructor <init>(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mRecordsInterrupted:Z
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->bBIPSuccess:Z

    new-instance v5, Ljava/util/HashMap;

    invoke-direct {v5}, Ljava/util/HashMap;-><init>()V

    iput-object v5, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mGidNetworkInfoMap:Ljava/util/HashMap;

    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mIsLraIdentifiersSetForSingleSku:Z
    ...
    :cond_0
    sget v5, Lcom/android/internal/telephony/uicc/SIMRecords;->PROJECT_SIM_NUM:I
    ...
    invoke-interface {v5, p0, v6, v8}, Lcom/android/internal/telephony/CommandsInterface;->registerForSimSwaped(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v4, "CscFeature_Common_AutoConfigurationType"
    ...
    const-string v3, "Loading GID network info for LRA suboperators now."
...
.method private getOplmnMcc(I[B)Ljava/lang/String;
    .locals 6
    .param p1, "position"    # I
    .param p2, "rawOPLMNwAcT"    # [B
    ...
    invoke-static {p2, v2, v1, v5, v3}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method private getOplmnMnc(I[B)Ljava/lang/String;
    .locals 11
    .param p1, "position"    # I
    .param p2, "rawOPLMNwAcT"    # [B
    ...
    invoke-static {p2, v6, v2, v9, v7}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    .local v1, "sMnc":Ljava/lang/String;
    goto :goto_0

    .end local v1    # "sMnc":Ljava/lang/String;
    :cond_2
    ...
    .restart local v1    # "sMnc":Ljava/lang/String;
    goto :goto_0
.end method
...
.method private handleFileUpdate(I)V
    ...
    invoke-virtual {v1, v6, v2, v5, v3}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;->loadFromEF(IIILandroid/os/Message;)V
...
.method private handleOPLMNwAcT([B)V
    .locals 5
    .param p1, "rawOPLMNwAcT"    # [B
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mOplmnList:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/internal/telephony/uicc/SIMRecords;->getOplmnMcc(I[B)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/internal/telephony/uicc/SIMRecords;->getOplmnMnc(I[B)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mOplmnList:Ljava/util/ArrayList;
    ...
    const-string v4, "mOplmnList :"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mOplmnList:Ljava/util/ArrayList;
...
.method private handleSimRefresh(Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->bBIPSuccess:Z

    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/SIMRecords;->refreshUiccVer()V
...
.method private isExistFirstSimFlag()Z
    ...
    const-string v1, "/data/misc/radio/firstSIM"

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .local v0, "oneChange":Ljava/io/File;
...
.method private loadGidNetworkInfo()V
    .locals 12
    ...
    const-string v10, "vendor/carrier/LRA/sub-ops.xml"

    invoke-direct {v5, v9, v10}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .local v5, "subOpsFile":Ljava/io/File;
    const/4 v7, 0x0

    .local v7, "subOpsReader":Ljava/io/FileReader;
    const/4 v6, 0x0

    .local v6, "subOpsParser":Lorg/xmlpull/v1/XmlPullParser;
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "subOpsFile = "
    ...
    .end local v7    # "subOpsReader":Ljava/io/FileReader;
    .local v8, "subOpsReader":Ljava/io/FileReader;
    :try_start_1
    ...
    .end local v8    # "subOpsReader":Ljava/io/FileReader;
    .restart local v7    # "subOpsReader":Ljava/io/FileReader;
    :cond_1
    :goto_1
    const-string v9, "SimRecord: loadGidNetworkInfo, loading of gid1 hashmap for LRA complete"
    ...
    .end local v7    # "subOpsReader":Ljava/io/FileReader;
    .restart local v8    # "subOpsReader":Ljava/io/FileReader;
    :cond_2
    const/4 v9, 0x0
    ...
    .local v4, "numericAndAlphaValues":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/SIMRecords;->mGidNetworkInfoMap:Ljava/util/HashMap;
    ...
    .end local v4    # "numericAndAlphaValues":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :catch_0
    move-exception v1
    ...
    const-string v10, "error loading subOpsFile "
...
.method public dispose()V
    ...
    invoke-interface {v1, p0}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForSimSwaped(Landroid/os/Handler;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_2
    sget v4, Lcom/android/internal/telephony/uicc/SIMRecords;->PROJECT_SIM_NUM:I
    ...
    .local v39, "lResult":Landroid/os/AsyncResult;
    if-eqz v39, :cond_3
    ...
    sget-object v6, Lcom/android/internal/telephony/CommandException$Error;->SIM_ABSENT:Lcom/android/internal/telephony/CommandException$Error;
    ...
    iget-boolean v6, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mRecordsInterrupted:Z
    ...
    iput-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mRecordsInterrupted:Z

    .end local v39    # "lResult":Landroid/os/AsyncResult;
    :cond_3
    :try_start_0
    move-object/from16 v0, p1
    ...
    .local v45, "mccmncCode":Ljava/lang/String;
    ...
    aget-object v44, v13, v26

    .local v44, "mccmnc":Ljava/lang/String;
    ...
    .end local v26    # "i$":I
    .end local v41    # "len$":I
    .end local v44    # "mccmnc":Ljava/lang/String;
    .end local v45    # "mccmncCode":Ljava/lang/String;
    :cond_c
    move-object/from16 v0, p0
    ...
    .local v43, "mcc":I
    invoke-static/range {v43 .. v43}, Lcom/android/internal/telephony/MccTable;->smallestDigitsMccForMnc(I)I
    ...
    .local v60, "sp":Landroid/content/SharedPreferences;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .end local v60    # "sp":Landroid/content/SharedPreferences;
    :cond_f
    :goto_5
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    .local v48, "operator":Ljava/lang/String;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .end local v48    # "operator":Ljava/lang/String;
    .restart local v13    # "arr$":[Ljava/lang/String;
    .restart local v26    # "i$":I
    .restart local v41    # "len$":I
    .restart local v44    # "mccmnc":Ljava/lang/String;
    .restart local v45    # "mccmncCode":Ljava/lang/String;
    :cond_13
    ...
    .restart local v60    # "sp":Landroid/content/SharedPreferences;
    :cond_14
    const/4 v4, 0x0
    ...
    .local v49, "phoneRestrictionPolicy":Landroid/sec/enterprise/PhoneRestrictionPolicy;
    const/16 v25, 0x0
    ...
    .local v40, "languagePolicy":Ljava/lang/String;
    if-eqz v40, :cond_4
    ...
    .end local v40    # "languagePolicy":Ljava/lang/String;
    .end local v49    # "phoneRestrictionPolicy":Landroid/sec/enterprise/PhoneRestrictionPolicy;
    :cond_2a
    move-object/from16 v0, v18
    ...
    .restart local v40    # "languagePolicy":Ljava/lang/String;
    .restart local v49    # "phoneRestrictionPolicy":Landroid/sec/enterprise/PhoneRestrictionPolicy;
    :cond_2d
    const-string v4, "33"
    ...
    .local v56, "simselswitch":Ljava/lang/String;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .end local v56    # "simselswitch":Ljava/lang/String;
    :cond_35
    :goto_10
    invoke-static {}, Lcom/sec/android/app/CscFeature;->getInstance()Lcom/sec/android/app/CscFeature;
    ...
    const-string v6, "CscFeature_RIL_SupportInitialAttachRequest"
    ...
    .restart local v56    # "simselswitch":Ljava/lang/String;
    :cond_38
    move-object/from16 v0, p0
    ...
    .local v57, "sixmode":Ljava/lang/String;
    ...
    .end local v57    # "sixmode":Ljava/lang/String;
    :cond_3b
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .restart local v57    # "sixmode":Ljava/lang/String;
    const-string v4, "ril.isctc"
    ...
    .local v67, "voiceForwarding_cff_cphs":Z
    :goto_1e
    const/16 v66, 0x0

    .local v66, "videoForwarding_cff_cphs":Z
    move-object/from16 v0, v18
    ...
    .end local v66    # "videoForwarding_cff_cphs":Z
    .end local v67    # "voiceForwarding_cff_cphs":Z
    :cond_72
    const/16 v67, 0x0

    goto :goto_1e

    .restart local v66    # "videoForwarding_cff_cphs":Z
    .restart local v67    # "voiceForwarding_cff_cphs":Z
    :cond_73
    const/16 v66, 0x0
    ...
    invoke-static/range {v62 .. v62}, Lcom/android/internal/telephony/uicc/IccUtils;->bytesToHexString([B)Ljava/lang/String;
    ...
    .local v53, "resource":Landroid/content/res/Resources;
    iget-object v4, v12, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    .end local v12    # "ar":Landroid/os/AsyncResult;
    .end local v53    # "resource":Landroid/content/res/Resources;
    :sswitch_1a
    const/16 v34, 0x0
    ...
    iget-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mRecordsInterrupted:Z

    if-eqz v4, :cond_4

    move-object/from16 v0, p0

    iget-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mRecordsRequested:Z

    if-eqz v4, :cond_4

    const-string v4, "Reload SIM Records"
    ...
    iput-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mRecordsRequested:Z
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->isAppReady()Z
    ...
    .local v59, "skt_irm":Ljava/lang/String;
    ...
    .end local v12    # "ar":Landroid/os/AsyncResult;
    .end local v18    # "data":[B
    .end local v59    # "skt_irm":Ljava/lang/String;
    :sswitch_21
    const/16 v34, 0x1
    ...
    const-string v6, "CscFeature_Common_AutoConfigurationType"
    ...
    const-string v6, "SimRecord: mGid1: "
    ...
    iget-object v6, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mGid1:Ljava/lang/String;
    ...
    .local v46, "numericAndAlphaValuesFromMap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mGidNetworkInfoMap:Ljava/util/HashMap;
    ...
    .end local v46    # "numericAndAlphaValuesFromMap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    check-cast v46, Ljava/util/ArrayList;

    .restart local v46    # "numericAndAlphaValuesFromMap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    if-eqz v46, :cond_99
    ...
    const-string v6, "SimRecord: mCombinedValueFromHashMap: "
    ...
    iput-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mIsLraIdentifiersSetForSingleSku:Z

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "SimRecord: gsm.sim.operator.numeric: "
    ...
    const-string v6, "SimRecord: gsm.sim.operator.alpha: "
    ...
    .restart local v20    # "editor":Landroid/content/SharedPreferences$Editor;
    .restart local v38    # "key_gid":Ljava/lang/String;
    .restart local v46    # "numericAndAlphaValuesFromMap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v60    # "sp":Landroid/content/SharedPreferences;
    :cond_99
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    const-string v6, "SimRecord: GID1 not found in map: "
    ...
    .end local v12    # "ar":Landroid/os/AsyncResult;
    :sswitch_28
    const-string v4, "[handleMessage] EVENT_GET_OPLMNWACT_DONE "
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/telephony/uicc/SIMRecords;->handleOPLMNwAcT([B)V
    ...
    :cond_9d
    const-string v4, "getting EF_OPLMNWACT have exception !!!! "
    ...
    .local v55, "roaming":Ljava/lang/String;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .end local v12    # "ar":Landroid/os/AsyncResult;
    .end local v18    # "data":[B
    .end local v55    # "roaming":Ljava/lang/String;
    :sswitch_2f
    const-string v65, ""

    .local v65, "uiccVer":Ljava/lang/String;
    const-string v64, ""

    .local v64, "uiccConv":Ljava/lang/String;
    const/16 v34, 0x1
    ...
    iget-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->bBIPSuccess:Z

    const/4 v6, 0x1

    if-ne v4, v6, :cond_4

    const-string v4, "broadcasting com.sec.android.lgt.bip.SUCCESS"
    ...
    const-string v4, "com.sec.android.lgt.bip.SUCCESS"
    ...
    iput-boolean v4, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->bBIPSuccess:Z
    ...
    .end local v18    # "data":[B
    .end local v22    # "ex":Ljava/lang/Exception;
    .end local v64    # "uiccConv":Ljava/lang/String;
    .end local v65    # "uiccVer":Ljava/lang/String;
    :sswitch_30
    const/16 v34, 0x1
    ...
    .local v42, "mPsismsc":Ljava/lang/String;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .end local v12    # "ar":Landroid/os/AsyncResult;
    .end local v18    # "data":[B
    .end local v42    # "mPsismsc":Ljava/lang/String;
    .end local v50    # "psismsclength":I
    :sswitch_31
    const/16 v34, 0x0
    ...
    .restart local v48    # "operator":Ljava/lang/String;
    invoke-static {}, Lcom/sec/android/app/CscFeature;->getInstance()Lcom/sec/android/app/CscFeature;
...
.method protected onAllRecordsLoaded()V
    ...
    invoke-direct {v0, v12}, Lcom/android/internal/telephony/uicc/SIMRecords;->SetSimOp(Ljava/lang/String;)V
    ...
    .restart local v5    # "cdmaop":Ljava/lang/String;
    new-instance v21, Ljava/lang/StringBuilder;
    ...
    const-string v22, "SIMBASED_SSKU"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/uicc/SIMRecords;->mIsLraIdentifiersSetForSingleSku:Z

    move/from16 v21, v0

    if-nez v21, :cond_18

    const-string v21, "330120"
    ...
    const-string v21, "SimRecord: SIM operator name and SIM operator alpha set for OpenMobile"
    ...
    const-string v21, "ro.com.google.clientidbase.ms"
    ...
    const-string v22, "android-tmobile"
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/uicc/SIMRecords;->isExistFirstSimFlag()Z
    ...
    const-string v22, " there is firstSIM flag"
...
.method protected resetRecords()V
    ...
    const-string v1, "gsm.sim.gsmoperator.numeric"

    invoke-virtual {p0, v1, v4}, Lcom/android/internal/telephony/uicc/SIMRecords;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
