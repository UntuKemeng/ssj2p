...
.field private static final EVENT_CHANGE_FACILITY_FDN_WAIT_UPDATE_DONE:I = 0x69
...
.method private onChangeFacilityLock(Landroid/os/AsyncResult;)V
    ...
    iget-boolean v3, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mDesiredPinLocked:Z
    ...
    iget-boolean v5, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mIccLockEnabled:Z

    invoke-static {v5}, Ljava/lang/Boolean;->toString(Z)Ljava/lang/String;

    move-result-object v5

    invoke-static {v2, v3, v5}, Landroid/telephony/TelephonyManager;->setTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)V

    const/4 v3, 0x1

    invoke-direct {p0, p1, v3}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->parsePinPukErrorResult(Landroid/os/AsyncResult;I)I
    ...
    const-string v5, "EVENT_CHANGE_FACILITY_LOCK_DONE: mIccLockEnabled= "
...
.method private onQueryFacilityLock(Landroid/os/AsyncResult;)V
    ...
    const-string v4, "Error in querying facility lock:"
    ...
    const-string v6, "Query facility lock : "
    ...
    const-string v4, "Ignoring: pin1state="
    ...
    const-string v3, "QUERY_FACILITY_LOCK:enabled GET_SIM_STATUS.Pin1:disabled. Fixme"
    ...
    const-string v3, "QUERY_FACILITY_LOCK:disabled GET_SIM_STATUS.Pin1:enabled. Fixme"
...
.method dispose()V
    ...
    const-string v3, " being Disposed"
    ...
    invoke-interface {v1, v3}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForNotAvailable(Landroid/os/Handler;)V
    ...
    invoke-static {v0, v1, v3}, Landroid/telephony/TelephonyManager;->setTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)V
