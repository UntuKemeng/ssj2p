...
.method public static filterDestAddr(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "filterDestAddr."
    ...
    .local v0, "debugNumber":Ljava/lang/String;
    const-string v5, "SmsNumberUtils"
    ...
    .end local v0    # "debugNumber":Ljava/lang/String;
    :cond_0
    if-eqz p1, :cond_1
    ...
    const-string v6, "destAddr is not a global phone number!"
    ...
    .restart local p1    # "destAddr":Ljava/lang/String;
    :cond_2
    ...
    const-string v7, "leave filterDestAddr, new destAddr=\""
    ...
    const-string v6, "getNetworkOperator is null or empty"
