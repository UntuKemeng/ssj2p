...
.field public static final enum WLAN_PM_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;

.field public static final enum WLAN_RX_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;

.field public static final enum WLAN_TXFL_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "WLAN_PM_WAKE"

    const/4 v2, 0x6

    invoke-direct {v0, v1, v2}, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;->WLAN_PM_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;

    new-instance v0, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;

    const-string v1, "WLAN_TXFL_WAKE"

    const/4 v2, 0x7

    invoke-direct {v0, v1, v2}, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;->WLAN_TXFL_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;
    ...
    sget-object v2, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;->WLAN_PM_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, Lcom/android/server/wifi/WifiStateMachine$WakeLockType;->WLAN_TXFL_WAKE:Lcom/android/server/wifi/WifiStateMachine$WakeLockType;
