...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2, v0}, Lcom/android/server/wifi/WifiTrafficPoller;->access$702(Lcom/android/server/wifi/WifiTrafficPoller;Z)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiTrafficPoller;->access$700(Lcom/android/server/wifi/WifiTrafficPoller;)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiTrafficPoller;->access$900(Lcom/android/server/wifi/WifiTrafficPoller;)I
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiTrafficPoller;->access$908(Lcom/android/server/wifi/WifiTrafficPoller;)I

    iget-object v0, p0, Lcom/android/server/wifi/WifiTrafficPoller$TrafficHandler;->this$0:Lcom/android/server/wifi/WifiTrafficPoller;

    # getter for: Lcom/android/server/wifi/WifiTrafficPoller;->mEnableTrafficStatsPoll:Z
    invoke-static {v0}, Lcom/android/server/wifi/WifiTrafficPoller;->access$700(Lcom/android/server/wifi/WifiTrafficPoller;)Z
    ...
    # getter for: Lcom/android/server/wifi/WifiTrafficPoller;->mTrafficStatsPollToken:I
    invoke-static {v0}, Lcom/android/server/wifi/WifiTrafficPoller;->access$900(Lcom/android/server/wifi/WifiTrafficPoller;)I
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiTrafficPoller;->access$1000(Lcom/android/server/wifi/WifiTrafficPoller;)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiTrafficPoller;->access$1100(Lcom/android/server/wifi/WifiTrafficPoller;)Ljava/util/List;
    ...
    # getter for: Lcom/android/server/wifi/WifiTrafficPoller;->mTrafficStatsPollToken:I
    invoke-static {v2}, Lcom/android/server/wifi/WifiTrafficPoller;->access$900(Lcom/android/server/wifi/WifiTrafficPoller;)I
    ...
    # getter for: Lcom/android/server/wifi/WifiTrafficPoller;->mClients:Ljava/util/List;
    invoke-static {v0}, Lcom/android/server/wifi/WifiTrafficPoller;->access$1100(Lcom/android/server/wifi/WifiTrafficPoller;)Ljava/util/List;
    ...
    # getter for: Lcom/android/server/wifi/WifiTrafficPoller;->mClients:Ljava/util/List;
    invoke-static {v2}, Lcom/android/server/wifi/WifiTrafficPoller;->access$1100(Lcom/android/server/wifi/WifiTrafficPoller;)Ljava/util/List;
