...
.method computeShownFrameLocked()V
    ...
    .local v26, "selfTransformation":Z
    move-object/from16 v0, p0
    ...
    .local v14, "horizontalModeTransformation":Landroid/view/animation/Transformation;
    const/4 v15, 0x0

    .local v15, "isAppTransitReady":Z
    move-object/from16 v0, p0
    ...
    .local v18, "mLowerWallpaperTarget":Lcom/android/server/wm/WindowState;
    move-object/from16 v0, p0
    ...
    .local v33, "wallpaperTarget":Lcom/android/server/wm/WindowState;
    :goto_2
    const/16 v17, 0x0

    .local v17, "isTransiting":Z
    move-object/from16 v0, p0
    ...
    .local v32, "wallpaperAnimator":Lcom/android/server/wm/WindowStateAnimator;
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/view/animation/Animation;->getDetachWallpaper()Z
    ...
    const-string v37, "WindowStateAnimator"

    new-instance v38, Ljava/lang/StringBuilder;

    invoke-direct/range {v38 .. v38}, Ljava/lang/StringBuilder;-><init>()V

    const-string v39, "WP target attached xform: "
    ...
    .local v34, "wpAppAnimator":Lcom/android/server/wm/AppWindowAnimator;
    :goto_3
    if-eqz v34, :cond_1
    ...
    const-string v39, "WP target app xform: "
    ...
    .end local v32    # "wallpaperAnimator":Lcom/android/server/wm/WindowStateAnimator;
    .end local v34    # "wpAppAnimator":Lcom/android/server/wm/AppWindowAnimator;
    :cond_1
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v10}, Lcom/android/server/wm/WindowAnimator;->getScreenRotationAnimationLocked(I)Lcom/android/server/wm/ScreenRotationAnimation;

    move-result-object v25

    .local v25, "screenRotationAnimation":Lcom/android/server/wm/ScreenRotationAnimation;
    if-eqz v25, :cond_1c
    ...
    .local v30, "virtualScreenOffset":Landroid/graphics/PointF;
    const/16 v37, 0x0
    ...
    .local v29, "tmpMatrix":Landroid/graphics/Matrix;
    if-eqz v24, :cond_1f

    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wm/ScreenRotationAnimation;->isRotating()Z
    ...
    cmpl-float v37, v31, v37

    if-ltz v37, :cond_1d

    const/high16 v37, 0x3f800000    # 1.0f

    cmpl-float v37, v13, v37
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/WindowState;->getMultiWindowStyleLw()Lcom/samsung/android/multiwindow/MultiWindowStyle;

    move-result-object v37

    invoke-virtual/range {v37 .. v37}, Lcom/samsung/android/multiwindow/MultiWindowStyle;->isCascade()Z
    ...
    div-float v39, v31, v39

    const/high16 v40, 0x40000000    # 2.0f

    div-float v40, v13, v40
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/view/animation/Transformation;->getMatrix()Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wm/ScreenRotationAnimation;->getEnterTransformation()Landroid/view/animation/Transformation;
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/graphics/RectF;->set(Landroid/graphics/RectF;)V
    ...
    invoke-static/range {v37 .. v37}, Landroid/graphics/PixelFormat;->formatHasAlpha(I)Z
    ...
    invoke-virtual/range {v37 .. v41}, Lcom/android/server/wm/WindowState;->isIdentityMatrix(FFFF)Z
    ...
    invoke-virtual/range {v38 .. v38}, Landroid/view/animation/Transformation;->getAlpha()F
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/graphics/Rect;->scale(F)V
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/WindowState;->getMainWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v37 .. v39}, Landroid/graphics/Rect;->offset(II)V
    ...
    .end local v22    # "offsetHeight":I
    .end local v23    # "offsetWidth":I
    :cond_13
    const/16 v37, 0x1
    ...
    .end local v11    # "fixedOrientationFlag":I
    :cond_15
    move-object/from16 v0, p0
    ...
    :cond_16
    sget-boolean v37, Lcom/android/server/wm/WindowManagerService;->DEBUG_SURFACE_TRACE:Z

    if-nez v37, :cond_24

    .end local v12    # "frame":Landroid/graphics/Rect;
    .end local v13    # "h":I
    .end local v28    # "tmpFloats":[F
    .end local v29    # "tmpMatrix":Landroid/graphics/Matrix;
    .end local v31    # "w":I
    .end local v35    # "x":F
    .end local v36    # "y":F
    :cond_17
    ...
    .end local v14    # "horizontalModeTransformation":Landroid/view/animation/Transformation;
    .end local v15    # "isAppTransitReady":Z
    .end local v17    # "isTransiting":Z
    .end local v18    # "mLowerWallpaperTarget":Lcom/android/server/wm/WindowState;
    .end local v19    # "mUpperWallpaperTarget":Lcom/android/server/wm/WindowState;
    .end local v20    # "mWallpaperTarget":Lcom/android/server/wm/WindowState;
    .end local v24    # "screenAnimation":Z
    .end local v25    # "screenRotationAnimation":Lcom/android/server/wm/ScreenRotationAnimation;
    .end local v30    # "virtualScreenOffset":Landroid/graphics/PointF;
    .end local v33    # "wallpaperTarget":Lcom/android/server/wm/WindowState;
    :cond_18
    const/4 v8, 0x0
    ...
    .restart local v14    # "horizontalModeTransformation":Landroid/view/animation/Transformation;
    .restart local v15    # "isAppTransitReady":Z
    .restart local v18    # "mLowerWallpaperTarget":Lcom/android/server/wm/WindowState;
    .restart local v19    # "mUpperWallpaperTarget":Lcom/android/server/wm/WindowState;
    .restart local v20    # "mWallpaperTarget":Lcom/android/server/wm/WindowState;
    :cond_1a
    move-object/from16 v33, v20

    goto/16 :goto_2

    .restart local v17    # "isTransiting":Z
    .restart local v32    # "wallpaperAnimator":Lcom/android/server/wm/WindowStateAnimator;
    .restart local v33    # "wallpaperTarget":Lcom/android/server/wm/WindowState;
    :cond_1b
    move-object/from16 v0, v33
    ...
    .restart local v25    # "screenRotationAnimation":Lcom/android/server/wm/ScreenRotationAnimation;
    :cond_1c
    const/16 v24, 0x0
    ...
    .local v13, "h":F
    .restart local v24    # "screenAnimation":Z
    .restart local v28    # "tmpFloats":[F
    .restart local v29    # "tmpMatrix":Landroid/graphics/Matrix;
    .restart local v30    # "virtualScreenOffset":Landroid/graphics/PointF;
    .local v31, "w":F
    :cond_1d
    move-object/from16 v0, p0
    ...
    .local v16, "isCascadedSurfaceView":Z
    :goto_9
    invoke-virtual/range {v29 .. v29}, Landroid/graphics/Matrix;->reset()V

    goto/16 :goto_5

    .end local v16    # "isCascadedSurfaceView":Z
    :cond_1e
    const/16 v16, 0x0
    ...
    .local v27, "spec":Landroid/view/MagnificationSpec;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v37 .. v38}, Lcom/android/server/wm/AccessibilityController;->getMagnificationSpecForWindowLocked(Lcom/android/server/wm/WindowState;)Landroid/view/MagnificationSpec;
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/view/MagnificationSpec;->isNop()Z
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/WindowState;->getWindowEasyOneHandScaleSpecLocked()Landroid/view/MagnificationSpec;
    ...
    .end local v27    # "spec":Landroid/view/MagnificationSpec;
    .local v13, "h":I
    .local v31, "w":I
    ...
    :cond_25
    const-string v38, "WindowStateAnimator"

    new-instance v37, Ljava/lang/StringBuilder;

    invoke-direct/range {v37 .. v37}, Ljava/lang/StringBuilder;-><init>()V

    const-string v39, "computeShownFrameLocked: Animating "
    ...
    .restart local v27    # "spec":Landroid/view/MagnificationSpec;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/AccessibilityController;->onSomeWindowResizedOrMovedLocked()V
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/graphics/RectF;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v37 .. v39}, Landroid/graphics/RectF;->offset(FF)V
...
.method createSurfaceLocked()Landroid/view/SurfaceControl;
    ...
    iget-boolean v2, v0, Lcom/android/server/wm/WindowStateAnimator;->mSecure:Z
...
.method public prepareSurfaceLocked(Z)V
    ...
    iget-boolean v6, v4, Lcom/android/server/wm/WindowState;->mWaitingForOrientation:Z
    ...
    const-string v7, "Orientation change skips hidden(mSurfaceControl is null && return mWaitingForOrientation(true)"
    ...
    :cond_1
    iget-boolean v6, v4, Lcom/android/server/wm/WindowState;->mOrientationChanging:Z
    ...
    const-string v9, "Orientation change skips hidden(mSurfaceControl is null) "
    ...
    const-string v9, " mWaitingForOrientation="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, v4, Lcom/android/server/wm/WindowState;->mWaitingForOrientation:Z
    ...
    .local v5, "waitingDisplaySizeDensity":Z
    invoke-virtual {p0}, Lcom/android/server/wm/WindowStateAnimator;->computeShownFrameLocked()V

    invoke-virtual {p0, p1}, Lcom/android/server/wm/WindowStateAnimator;->setSurfaceBoundariesLocked(Z)V

    iget-boolean v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mIsWallpaper:Z

    if-eqz v8, :cond_6

    iget-object v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mWin:Lcom/android/server/wm/WindowState;

    iget-boolean v8, v8, Lcom/android/server/wm/WindowState;->mWallpaperVisible:Z
    ...
    iget-boolean v8, v4, Lcom/android/server/wm/WindowState;->mOrientationChanging:Z
    ...
    iget v8, v7, Lcom/android/server/wm/WindowAnimator;->mBulkUpdateParams:I

    and-int/lit8 v8, v8, -0x9

    iput v8, v7, Lcom/android/server/wm/WindowAnimator;->mBulkUpdateParams:I

    iget-object v7, p0, Lcom/android/server/wm/WindowStateAnimator;->mAnimator:Lcom/android/server/wm/WindowAnimator;

    iput-object v4, v7, Lcom/android/server/wm/WindowAnimator;->mLastWindowFreezeSource:Ljava/lang/Object;
    ...
    const-string v9, "Orientation continue waiting for draw in "
    ...
    iput-boolean v6, v7, Lcom/android/server/wm/WindowToken;->hasVisible:Z

    goto :goto_0

    :cond_6
    iget-boolean v8, v4, Lcom/android/server/wm/WindowState;->mAttachedHidden:Z
    ...
    invoke-virtual {v8, v4}, Lcom/android/server/wm/WindowManagerService;->hideWallpapersLocked(Lcom/android/server/wm/WindowState;)V
    ...
    iget v8, v0, Lcom/android/server/wm/DisplayContent;->mPrevDisplayHeight:I

    if-eqz v8, :cond_8

    iget v8, v0, Lcom/android/server/wm/DisplayContent;->mPrevDisplayWidth:I
    ...
    const-string v10, "Orientation change skips hidden (hidden)"
    ...
    :cond_9
    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastLayer:I

    iget v9, p0, Lcom/android/server/wm/WindowStateAnimator;->mAnimLayer:I

    if-ne v8, v9, :cond_a

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastAlpha:F

    iget v9, p0, Lcom/android/server/wm/WindowStateAnimator;->mShownAlpha:F

    cmpl-float v8, v8, v9

    if-nez v8, :cond_a

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDsDx:F

    iget v9, p0, Lcom/android/server/wm/WindowStateAnimator;->mDsDx:F

    cmpl-float v8, v8, v9

    if-nez v8, :cond_a

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDtDx:F
    ...
    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDsDy:F
    ...
    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDtDy:F
    ...
    iget v8, v4, Lcom/android/server/wm/WindowState;->mLastHScale:F

    iget v9, v4, Lcom/android/server/wm/WindowState;->mHScale:F

    cmpl-float v8, v8, v9

    if-nez v8, :cond_a

    iget v8, v4, Lcom/android/server/wm/WindowState;->mLastVScale:F

    iget v9, v4, Lcom/android/server/wm/WindowState;->mVScale:F

    cmpl-float v8, v8, v9

    if-nez v8, :cond_a

    iget-boolean v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastHidden:Z
    ...
    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mShownAlpha:F

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastAlpha:F

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mAnimLayer:I

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastLayer:I

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mDsDx:F

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDsDx:F

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mDtDx:F

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDtDx:F

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mDsDy:F

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDsDy:F

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mDtDy:F

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastDtDy:F

    iget v8, v4, Lcom/android/server/wm/WindowState;->mHScale:F

    iput v8, v4, Lcom/android/server/wm/WindowState;->mLastHScale:F

    iget v8, v4, Lcom/android/server/wm/WindowState;->mVScale:F

    iput v8, v4, Lcom/android/server/wm/WindowState;->mLastVScale:F
    ...
    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceAlpha:F

    iget-object v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceControl:Landroid/view/SurfaceControl;

    iget v9, p0, Lcom/android/server/wm/WindowStateAnimator;->mShownAlpha:F

    invoke-virtual {v8, v9}, Landroid/view/SurfaceControl;->setAlpha(F)V

    iget v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mAnimLayer:I

    iput v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceLayer:I

    iget-object v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceControl:Landroid/view/SurfaceControl;

    iget v9, p0, Lcom/android/server/wm/WindowStateAnimator;->mAnimLayer:I

    invoke-virtual {v8, v9}, Landroid/view/SurfaceControl;->setLayer(I)V
    ...
    .local v3, "isCascadedSurfaceView":Z
    :goto_3
    iget-object v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceControl:Landroid/view/SurfaceControl;

    iget v9, p0, Lcom/android/server/wm/WindowStateAnimator;->mDsDx:F

    iget v10, v4, Lcom/android/server/wm/WindowState;->mHScale:F

    mul-float/2addr v9, v10

    iget v10, p0, Lcom/android/server/wm/WindowStateAnimator;->mDtDx:F

    iget v11, v4, Lcom/android/server/wm/WindowState;->mVScale:F

    mul-float/2addr v10, v11

    iget v11, p0, Lcom/android/server/wm/WindowStateAnimator;->mDsDy:F

    iget v12, v4, Lcom/android/server/wm/WindowState;->mHScale:F

    mul-float/2addr v11, v12

    iget v12, p0, Lcom/android/server/wm/WindowStateAnimator;->mDtDy:F

    iget v13, v4, Lcom/android/server/wm/WindowState;->mVScale:F
    ...
    const-string v10, " during relayout"
    ...
    iput-boolean v8, p0, Lcom/android/server/wm/WindowStateAnimator;->mLastHidden:Z
    ...
    invoke-virtual {v8, v4, v9}, Lcom/android/server/wm/WindowManagerService;->dispatchWallpaperVisibility(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-virtual {v8, v9, v10}, Lcom/android/server/wm/WindowAnimator;->setPendingLayoutChanges(II)V
    ...
    iput-boolean v9, v8, Lcom/android/server/wm/WindowToken;->hasVisible:Z
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    goto/16 :goto_1

    .end local v3    # "isCascadedSurfaceView":Z
    :catch_0
    move-exception v2
    ...
    invoke-virtual {v8, p0, v9, v6}, Lcom/android/server/wm/WindowManagerService;->reclaimSomeSurfaceMemoryLocked(Lcom/android/server/wm/WindowStateAnimator;Ljava/lang/String;Z)Z
    ...
    .restart local v3    # "isCascadedSurfaceView":Z
    :cond_f
    const/4 v8, 0x0
    ...
    const-string v10, "Orientation change skips hidden (showSurfaceRobustlyLocked is failed)"
    ...
    const-string v10, "prepareSurface: No changes in animation for "
    ...
    const-string v9, "Orientation change complete in "
    ...
    iput-object v4, v6, Lcom/android/server/wm/WindowAnimator;->mLastWindowFreezeSource:Ljava/lang/Object;
    ...
    const-string v8, "Orientation continue waiting(waitingDisplaySizeDensity) for draw in "
    ...
    const-string v8, "Orientation change skips not display in "
