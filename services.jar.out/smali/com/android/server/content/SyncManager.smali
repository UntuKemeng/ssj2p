...
.method onAppNotIdle(Ljava/lang/String;I)V
    ...
    .prologue
    iget-object v5, p0, Lcom/android/server/content/SyncManager;->mSyncQueue:Lcom/android/server/content/SyncQueue;
    ...
    invoke-virtual {v4}, Lcom/android/server/content/SyncQueue;->getOperations()Ljava/util/Collection;
    ...
    .local v3, "operationIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/content/SyncOperation;>;"
    const/4 v0, 0x0
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/content/SyncManager;->getPackageName(Lcom/android/server/content/SyncStorageEngine$EndPoint;)Ljava/lang/String;

    move-result-object v2

    .local v2, "opPackageName":Ljava/lang/String;
    iget-boolean v4, v1, Lcom/android/server/content/SyncOperation;->appIdle:Z
    ...
    iput-boolean v4, v1, Lcom/android/server/content/SyncOperation;->appIdle:Z
    ...
    .end local v3    # "operationIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/content/SyncOperation;>;"
    :catchall_0
    move-exception v4
