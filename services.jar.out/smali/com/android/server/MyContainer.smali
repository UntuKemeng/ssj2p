...
.method public changeAppDomain(Ljava/lang/String;ILjava/lang/String;Z)I
    ...
    const-string v8, "Apptype not SEAMS.GENERIC_SECURED_APPTYPE"
    ...
    const-string v8, " changeAppDomain failed, no packageName found"
    ...
    const-string v8, "changeDomainMDMID is null, Returning null"
    ...
    const-string v8, "changeAppDomain, Given Container ID not created by Caller - Returning Refused"
    ...
    const-string v8, "changeAppDomain, signature is null"
    ...
    const-string v8, "changeAppDomain, sigs is null"
    ...
    const-string v8, "Can\'t get appInfo from package"
    ...
    const-string v8, "changeAppDomain, Got Application Info, Seinfo is not null"
    ...
    const-string v8, "changeAppDomain, Got Application Info, appinfo.category is 0"
    ...
    const-string v8, "changeAppDomain: loadContainerSetting failed"
    ...
    const-string v8, "changeAppDomain: addEntryToMac failed"
    ...
    invoke-virtual {v6, v0}, Lcom/sec/enterprise/knox/seams/SEAMS;->relabelAppDir(Ljava/lang/String;)I
...
.method public createChangeDomain(II)I
    ...
    const-string v3, "createChangeDomain, changeDomainMDMID is null"
    ...
    const-string v3, "createChangeDomain, Issue with myContainerDir directory"
    ...
    const-string v3, "createChangeDomain, The Agent is a Container App"
    ...
    const-string v3, "createChangeDomain, Generic Container Count Overflow"
    ...
    const-string v3, "createChangeDomain: addEntryToMac failed"
    ...
    const-string v3, "createChangeDomain: loadcontainersetting failed"
