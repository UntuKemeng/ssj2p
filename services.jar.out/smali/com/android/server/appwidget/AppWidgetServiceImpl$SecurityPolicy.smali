...
.method public getEnabledGroupProfileIds(I)[I
    ...
    invoke-static {v10}, Landroid/os/PersonaManager;->isBBCContainer(I)Z
...
.method public getGroupParent(I)I
    ...
    invoke-static {v1}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2700(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;
...
.method public isProviderWhiteListed(Ljava/lang/String;I)Z
    ...
    :cond_1
    :try_start_0
    iget-object v7, p0, Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;->this$0:Lcom/android/server/appwidget/AppWidgetServiceImpl;

    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mPackageManager:Landroid/content/pm/IPackageManager;
    invoke-static {v7}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2000(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/content/pm/IPackageManager;
    ...
    iget-object v4, v7, Landroid/content/pm/ApplicationInfo;->metaData:Landroid/os/Bundle;
    ...
    const-string v7, "com.samsung.android.knoxenabled"
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, p2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;->getGroupParent(I)I
    ...
    # invokes: Lcom/android/server/appwidget/AppWidgetServiceImpl;->getDualProfileId(I)I
    invoke-static {v7, v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2600(Lcom/android/server/appwidget/AppWidgetServiceImpl;I)I

    move-result v2

    .local v2, "dualProfileId":I
    const/4 v7, -0x1
    ...
    .end local v0    # "crossProfilePackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v2    # "dualProfileId":I
