...
.method private findRestoredWidgetLocked(ILcom/android/server/appwidget/AppWidgetServiceImpl$Host;Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;)Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;
    ...
    invoke-static {v4}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2900(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Ljava/util/ArrayList;
...
.method private packageNeedsWidgetBackupLocked(Ljava/lang/String;I)Z
    ...
    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mWidgets:Ljava/util/ArrayList;
    invoke-static {v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2900(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Ljava/util/ArrayList;
...
.method private pruneWidgetStateLocked(Ljava/lang/String;I)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->access$3300(Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;Ljava/lang/String;I)Z
...
.method public getWidgetState(Ljava/lang/String;I)[B
    ...
    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mProviders:Ljava/util/ArrayList;
    invoke-static {v9}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3000(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v6}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3100(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;)V
    ...
    invoke-static {v9}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3200(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Ljava/util/ArrayList;
    ...
    # invokes: Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->hostsPackageForUser(Ljava/lang/String;I)Z
    invoke-static {v2, p1, p2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->access$3300(Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;Ljava/lang/String;I)Z
    ...
    invoke-static {v5, v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3400(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;)V
    ...
    invoke-static {v5, v8}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3500(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;)V
...
.method public restoreWidgetState(Ljava/lang/String;[BI)V
    ...
    # invokes: Lcom/android/server/appwidget/AppWidgetServiceImpl;->updateWidgetProviderForUpgradeM(Ljava/lang/String;Ljava/lang/String;)Landroid/content/ComponentName;
    invoke-static {v0, v15, v4}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3600(Lcom/android/server/appwidget/AppWidgetServiceImpl;Ljava/lang/String;Ljava/lang/String;)Landroid/content/ComponentName;

    move-result-object v12

    .line 4364
    .local v12, "newWidgetProvider":Landroid/content/ComponentName;
    if-eqz v12, :cond_3
    ...
    const-string v30, "Found renamed widget provider, change to "
    ...
    invoke-direct {v13, v0}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl$1;)V
    ...
    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mProviders:Ljava/util/ArrayList;
    invoke-static/range {v27 .. v27}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$3000(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Ljava/util/ArrayList;
    ...
    .end local v12    # "newWidgetProvider":Landroid/content/ComponentName;
    .end local v13    # "p":Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    .end local v15    # "pkg":Ljava/lang/String;
    .end local v21    # "tag":Ljava/lang/String;
    :cond_5
    ...
    invoke-static {v0, v15, v1}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2200(Lcom/android/server/appwidget/AppWidgetServiceImpl;Ljava/lang/String;I)I
    ...
    .line 4443
    iput-object v13, v11, Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;->provider:Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
