...
.method public removeAppFromContainer(Ljava/lang/String;[Ljava/lang/String;II)I
    ...
    .local v1, "appNotInstalled":Z
    const/4 v3, 0x0

    .local v3, "certMatch":Z
    const/4 v2, 0x0

    .local v2, "appTypeFound":Z
    const/4 v10, -0x1
    ...
    :try_start_0
    invoke-virtual {p0, p1, v10}, Lcom/android/server/GoodContainer;->getSEContainerIDsFromPackageName(Ljava/lang/String;I)[I

    move-result-object v4

    .local v4, "containerIds":[I
    const/4 v10, 0x0
    ...
    .restart local v4    # "containerIds":[I
    :cond_1
    const/4 v10, 0x2
    ...
    sget-object v10, Lcom/android/server/GoodContainer;->mSKLog:Lcom/android/server/SKLogger;

    const-string v11, "GoodContainer"
    ...
    const-string v10, "/data/security/good/mac_permissions.xml"

    invoke-direct {v7, v10}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .local v7, "macPermFile":Ljava/io/File;
    ...
    .end local v7    # "macPermFile":Ljava/io/File;
    :cond_7
    const/4 v10, 0x0
    ...
    .restart local v7    # "macPermFile":Ljava/io/File;
    :cond_9
    const/16 v10, 0x66
    ...
    invoke-static {v7, v8, p1, v10, v0}, Lcom/android/server/GoodContainer;->removeEntryFromMac(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, p1, v10, v1}, Lcom/android/server/GoodContainer;->loadContainerSetting(Ljava/lang/String;IZ)I
    ...
    sget-object v10, Lcom/android/server/GoodContainer;->mContext:Landroid/content/Context;

    invoke-static {v10}, Lcom/sec/enterprise/knox/seams/SEAMS;->getInstance(Landroid/content/Context;)Lcom/sec/enterprise/knox/seams/SEAMS;

    move-result-object v10

    invoke-virtual {v10, p1}, Lcom/sec/enterprise/knox/seams/SEAMS;->relabelAppDir(Ljava/lang/String;)I
