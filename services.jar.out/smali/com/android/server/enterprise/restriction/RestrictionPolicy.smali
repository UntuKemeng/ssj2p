...
.field private static final SELCETIVE_FOTA_CORPID_ANONYMOUS:Ljava/lang/String; = "ANONYMOUS"
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/enterprise/application/ApplicationPolicy;Lcom/android/server/enterprise/vpn/VpnInfoPolicy;)V
    ...
    .line 653
    iput-object v5, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    const-string v4, "com.sec.android.fotaclient.permission.FOTA"
    ...
    iput-object v2, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->mPersonaMgr:Landroid/os/PersonaManager;

    .line 466
    iget-object v2, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->mPersonaMgr:Landroid/os/PersonaManager;
    ...
    invoke-direct {v3, p0, v5}, Lcom/android/server/enterprise/restriction/RestrictionPolicy$SystemPersonaObserver;-><init>(Lcom/android/server/enterprise/restriction/RestrictionPolicy;Lcom/android/server/enterprise/restriction/RestrictionPolicy$1;)V
    ...
    iput-object v2, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->mStatusBar:Landroid/app/StatusBarManager;
...
.method static synthetic access$1000(Lcom/android/server/enterprise/restriction/RestrictionPolicy;IZ)Z
    .locals 1
...
.method static synthetic access$400(Lcom/android/server/enterprise/restriction/RestrictionPolicy;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
...
.method static synthetic access$500(Lcom/android/server/enterprise/restriction/RestrictionPolicy;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
    .param p1, "x1"    # I
...
.method static synthetic access$600(Lcom/android/server/enterprise/restriction/RestrictionPolicy;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
...
.method static synthetic access$700(Lcom/android/server/enterprise/restriction/RestrictionPolicy;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
...
.method static synthetic access$800(Lcom/android/server/enterprise/restriction/RestrictionPolicy;)Landroid/bluetooth/BluetoothProfile$ServiceListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
...
.method static synthetic access$900(Lcom/android/server/enterprise/restriction/RestrictionPolicy;Z)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
    .param p1, "x1"    # Z
...
.method private clearSelectiveFota()Z
    ...
    const-string v2, "SelectiveFotaTable"

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v3}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->delete(Ljava/lang/String;Landroid/content/ContentValues;)I
...
.method private static getHash(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "getHash : hashed imei: "
...
.method private isPackageOnExclusionList(ILjava/lang/String;)Z
    ...
    .line 5123
    sget-object v7, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->excludedAdminList:[Ljava/lang/String;
    ...
    const-string/jumbo v9, "preventAdminActivationWhiteList"
    ...
    .line 5132
    .local v5, "whitelisted_admins":[Ljava/lang/String;
    move-object v1, v5
    ...
    .end local v2    # "i$":I
    .end local v3    # "len$":I
    .end local v5    # "whitelisted_admins":[Ljava/lang/String;
    :cond_3
    const/4 v6, 0x0
...
.method private isUpdatableSelectiveFota(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v7, v8, v6, v3}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getValuesList(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;)Ljava/util/List;
...
.method private sendSeletiveFotaResult(I)V
    ...
    const-string/jumbo v3, "sendSeletiveFotaResult: result = "
    ...
    const-string v1, "com.sec.enterprise.intent.extra.UPDATE_FOTA_VERSION_STATUS"
    ...
    const-string v3, "android.permission.sec.MDM_RESTRICTION"
...
.method public allowFirmwareAutoUpdate(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 4526
    .local v8, "token":J
    invoke-virtual {p0, p1, v4}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isFirmwareAutoUpdateAllowed(Landroid/app/enterprise/ContextInfo;Z)Z
...
.method public allowUsbHostStorage(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isUsbHostStorageAllowed(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    const-string v3, "allowUsbHostStorage() : failed to call updateUsbStorageStatebyIntent()"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 5722
    const-string v8, "Permission Denial: can\'t dump Restriction Policy"
    ...
    const-string v8, "[Restriction Policy]"
    ...
    .line 5728
    .local v7, "userId":I
    const-string v8, "[Restrictions applied for user : "
    ...
    .line 5732
    invoke-direct {p0, v7}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->getRestrictionPoliciesLocked(I)Ljava/lang/Long;
...
.method public getAllowedFOTAInfo(Landroid/app/enterprise/ContextInfo;)Ljava/util/List;
    .locals 10
    .param p1, "cxtInfo"    # Landroid/app/enterprise/ContextInfo;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    const-string/jumbo v8, "getAllowedFOTAInfo"
    ...
    invoke-virtual {v7, v8, v6, v2}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getValuesList(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;)Ljava/util/List;
    ...
    const-string/jumbo v8, "getAllowedFOTAInfo: cursor is null"
...
.method public getAllowedFOTAVersion(Landroid/app/enterprise/ContextInfo;)Ljava/lang/String;
    .locals 2
    .param p1, "cxtInfo"    # Landroid/app/enterprise/ContextInfo;

    .prologue
    .line 5556
    invoke-virtual {p0, p1}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->getAllowedFOTAInfo(Landroid/app/enterprise/ContextInfo;)Ljava/util/List;
...
.method public onAdminRemoved(I)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->loadRestrictionCache(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isFactoryResetAllowed(Landroid/app/enterprise/ContextInfo;)Z

    .line 2767
    invoke-virtual {p0, v0, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isFirmwareRecoveryAllowed(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isMicrophoneEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-static {v4, v1, v5}, Lcom/android/server/enterprise/utils/Utils;->writePropertyValue(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isScreenCaptureEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 2774
    invoke-virtual {p0, v6}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isSDCardWriteAllowed(Landroid/app/enterprise/ContextInfo;)Z

    move-result v1

    iget-boolean v4, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->preAdminRemoval_SDCardWrite:Z
    ...
    invoke-direct {p0, v1}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->rollBackSVoice(I)V
    ...
    invoke-direct {v1, v4}, Landroid/app/enterprise/ContextInfo;-><init>(I)V

    invoke-virtual {p0, v1, v6, v6}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->setAllowedFOTAVersion(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isUsbHostStorageAllowed(Landroid/app/enterprise/ContextInfo;Z)Z

    move-result v1

    invoke-direct {p0, v1}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->updateUsbStorageStatebyIntent(Z)Z

    .line 2795
    iget-boolean v1, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isLockScreenWidgetsAllowedCache:Z

    if-nez v1, :cond_1

    invoke-virtual {p0, v6, v2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isLockScreenViewAllowed(Landroid/app/enterprise/ContextInfo;I)Z
    ...
    .line 2797
    invoke-direct {p0, v2, v2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->setLockScreenViewProperty(IZ)Z
    ...
    .line 2800
    :cond_1
    iget-boolean v1, p0, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isLockScreenShortcutsAllowedCache:Z

    if-nez v1, :cond_2

    invoke-virtual {p0, v6, v7}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isLockScreenViewAllowed(Landroid/app/enterprise/ContextInfo;I)Z
    ...
    .line 2802
    invoke-direct {p0, v7, v2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->setLockScreenViewProperty(IZ)Z
...
.method public setAllowedFOTAVersion(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Landroid/os/Bundle;)Z
    .locals 18
    .param p1, "cxtInfo"    # Landroid/app/enterprise/ContextInfo;
    ...
    .line 5441
    .local v4, "defaultCorp":Ljava/lang/String;
    const-string v5, "NONE"

    .line 5442
    .local v5, "defaultVersion":Ljava/lang/String;
    const/4 v2, 0x0
    ...
    .line 5445
    .local v11, "tergetVersion":Ljava/lang/String;
    invoke-direct/range {p0 .. p1}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->enforceOwnerOnlyAndRestrictionPermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    ...
    invoke-direct {v0, v15, v2, v1}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isUpdatableSelectiveFota(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v3, v15, v11}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    .line 5489
    const-string v15, "corpid"
    ...
    const-string v16, "SelectiveFotaTable"

    move-object/from16 v0, v16

    invoke-virtual {v15, v0, v3, v10}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->put(Ljava/lang/String;Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    ...
    invoke-virtual {v11, v15, v0}, Ljava/lang/String;->indexOf(Ljava/lang/String;I)I
    ...
    const-string/jumbo v17, "setAllowedFOTAVersion : invalid format : "
