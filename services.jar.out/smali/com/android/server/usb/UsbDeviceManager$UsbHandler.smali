...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mSCafeVersion:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$900()Ljava/lang/String;
    ...
    iput-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->isGrace:Z
    ...
    invoke-static {p1, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$1402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1700(Lcom/android/server/usb/UsbDeviceManager;)V
    :try_end_0
...
.method static synthetic access$1202(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    .param p1, "x1"    # Z
...
.method static synthetic access$1300(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
...
.method static synthetic access$1302(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
...
.method static synthetic access$3700(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
...
.method static synthetic access$3800(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
...
.method static synthetic access$3900(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
...
.method static synthetic access$4000(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
...
.method static synthetic access$800(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    .param p1, "x1"    # Z
...
.method private getDefaultFunctions()Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAdbEnabled:Z
    invoke-static {v7, v0}, Lcom/android/server/usb/UsbDeviceManager;->access$1402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$2900()Z
...
.method private getKnoxCustomUsbConnectionType()I
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mContext:Landroid/content/Context;
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
...
.method private isUsbTransferAllowed()Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mContext:Landroid/content/Context;
    invoke-static {v1}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
...
.method private setAdbEnabled(Z)V
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAdbEnabled:Z
    invoke-static {v2, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1800(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
...
.method private showUsbBlockAlertDialog()V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mContext:Landroid/content/Context;
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
...
.method private trySetEnabledFunctions(Ljava/lang/String;Z)Z
    ...
    invoke-static {v2, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "Setting USB config ["
...
.method private updateAudioSourceFunction()V
    ...
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2500(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbAlsaManager;
...
.method private updateCurrentAccessory()V
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$2000(Lcom/android/server/usb/UsbDeviceManager;)J
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAccessoryModeRequestTime:J
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$2000(Lcom/android/server/usb/UsbDeviceManager;)J
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAccessoryStrings:[Ljava/lang/String;
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$2100(Lcom/android/server/usb/UsbDeviceManager;)[Ljava/lang/String;
    ...
    invoke-static {v1, v10, v11}, Lcom/android/server/usb/UsbDeviceManager;->access$2002(Lcom/android/server/usb/UsbDeviceManager;J)J
    ...
    invoke-static {v1, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$2102(Lcom/android/server/usb/UsbDeviceManager;[Ljava/lang/String;)[Ljava/lang/String;
...
.method private updateMidiFunction()V
    ...
    invoke-static {v4, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$2702(Lcom/android/server/usb/UsbDeviceManager;I)I
    ...
    invoke-static {v4, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$2802(Lcom/android/server/usb/UsbDeviceManager;I)I
    :try_end_1
    .catch Ljava/io/FileNotFoundException; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-static {v4, v1}, Lcom/android/server/usb/UsbDeviceManager;->access$2602(Lcom/android/server/usb/UsbDeviceManager;Z)Z

    :cond_1
    iget-object v4, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->this$0:Lcom/android/server/usb/UsbDeviceManager;

    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mUsbAlsaManager:Lcom/android/server/usb/UsbAlsaManager;
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$2500(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbAlsaManager;
    ...
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2700(Lcom/android/server/usb/UsbDeviceManager;)I
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$2800(Lcom/android/server/usb/UsbDeviceManager;)I
...
.method private updateUsbNotification(Z)V
    ...
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->usbDisableSettingVal:Ljava/lang/String;
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->access$3400(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/KeyguardManager;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mKeyguardManager:Landroid/app/KeyguardManager;
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$3400(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/KeyguardManager;
    ...
    invoke-static {v0, v1}, Lcom/android/server/usb/UsbDeviceManager;->access$3300(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Z
...
.method private updateUsbNotification_Lock(Z)V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mUpdateNotiLock:Ljava/lang/Object;
    invoke-static {v1}, Lcom/android/server/usb/UsbDeviceManager;->access$3500(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/Object;
    ...
    const-string v2, "Error updateUsbNotification()"
...
.method private updateUsbStateBroadcast()V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mContext:Landroid/content/Context;
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v2, "    TAPowerConnected: "
    ...
    const-string v2, "    HostConnectionState: "
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mUseUsbNotification:Z
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$3200(Lcom/android/server/usb/UsbDeviceManager;)Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mBootCompleted:Z
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$2200(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mSupportDualRole:Z
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$1000(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    iget v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mDualRoleState:I
    ...
    const-string v12, "MSG_UPDATE_STATE : mDualRoleState is not none."
    ...
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$700(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string v12, "MSG_UPDATE_STATE : mSetNextUsbModeToDefault set usb mode default!!"
    ...
    invoke-static {v11, v12}, Lcom/android/server/usb/UsbDeviceManager;->access$702(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mContext:Landroid/content/Context;
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->getCurrentSettings()Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$2300(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mDebuggingManager:Lcom/android/server/usb/UsbDebuggingManager;
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$1800(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAdbEnabled:Z
    invoke-static {v12}, Lcom/android/server/usb/UsbDeviceManager;->access$1400(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mBootCompleted:Z
    invoke-static {v13}, Lcom/android/server/usb/UsbDeviceManager;->access$2200(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    iget-object v13, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mCurrentFunctions:Ljava/lang/String;

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "), mPowerConnected("

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-boolean v13, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mPowerConnected:Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->usbDisableSettingVal:Ljava/lang/String;
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    const-string v13, "Maximum Power Saving Mode Toast mHostConnected : "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-boolean v13, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mHostConnected:Z

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, " mConnected : "
    ...
    const-string v13, " mHostConnectionState"
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mHostConnectionState:Z
    invoke-static {v13}, Lcom/android/server/usb/UsbDeviceManager;->access$600(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string v13, " mTAPowerConnected : "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-boolean v13, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mTAPowerConnected:Z
    ...
    const-string/jumbo v12, "reserve_battery_on"
    ...
    :goto_a
    iput-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mRBM:Z
    ...
    const-string v12, "enable_reserve_max_mode"
    ...
    :goto_b
    iput-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mEnableRBM:Z
    ...
    iget-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->isGrace:Z
    ...
    :cond_25
    iget-object v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->value:Ljava/lang/String;

    const-string/jumbo v12, "powerplanning"
    ...
    const-string/jumbo v12, "reserve"
    ...
    iget-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mRBM:Z

    if-eqz v11, :cond_26

    iget-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mEnableRBM:Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mHostConnectionState:Z
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->access$600(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string/jumbo v13, "handleMessage -> MSG_TA_POWER_STATE = "
    ...
    const-string v12, "MSG_TA_POWER_STATE : DEVICE is CHARGING via TA"
    ...
    const-string v12, "MSG_TA_POWER_STATE : SETUP WIZARD SCREEN. So skip about showing USB BLOCK Popup"
...
.method public updateHostState(Landroid/hardware/usb/UsbPort;Landroid/hardware/usb/UsbPortStatus;)V
    ...
    const-string v6, ", mDualRoleState : "
