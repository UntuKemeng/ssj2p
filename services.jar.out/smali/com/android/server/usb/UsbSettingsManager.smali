...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/usb/UsbSettingsManager;->DEBUG_PROCESS:Z
...
.method private isPreinstolledPackage(Ljava/util/List;Ljava/lang/String;)Z
    ...
    .line 772
    .local v1, "ret":Z
    iget-object v3, p0, Lcom/android/server/usb/UsbSettingsManager;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 773
    :goto_0
    sget-boolean v3, Lcom/android/server/usb/UsbSettingsManager;->RELEASE_BUILD:Z

    if-eq v3, v2, :cond_1

    .line 774
    sget-boolean v2, Lcom/android/server/usb/UsbSettingsManager;->DEBUG_PROCESS:Z
...
.method private isSmartSwitchInTheProcess(Landroid/hardware/usb/UsbDevice;Ljava/util/List;)Z
    ...
    sget-boolean v5, Lcom/android/server/usb/UsbSettingsManager;->DEBUG_PROCESS:Z
    ...
    invoke-direct {p0, p2, v5}, Lcom/android/server/usb/UsbSettingsManager;->isPreinstolledPackage(Ljava/util/List;Ljava/lang/String;)Z
    ...
    const-string/jumbo v6, "isSmartSwitchInTheProcess: set it as default"

    invoke-static {v5, v6}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 797
    :cond_4
    iput-boolean v7, p0, Lcom/android/server/usb/UsbSettingsManager;->mSmartSwitchInTheProcess:Z
...
.method private requestPermissionDialog(Landroid/content/Intent;Ljava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 1143
    iget-boolean v5, p0, Lcom/android/server/usb/UsbSettingsManager;->mSmartSwitchInTheProcess:Z
    ...
    iget-boolean v7, p0, Lcom/android/server/usb/UsbSettingsManager;->mSmartSwitchInTheProcess:Z
...
.method public deviceAttached(Landroid/hardware/usb/UsbDevice;)V
    ...
    .line 814
    .local v2, "matches":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/ResolveInfo;>;"
    invoke-direct {p0, p1, v2}, Lcom/android/server/usb/UsbSettingsManager;->isSmartSwitchInTheProcess(Landroid/hardware/usb/UsbDevice;Ljava/util/List;)Z
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-boolean v9, p0, Lcom/android/server/usb/UsbSettingsManager;->mSmartSwitchInTheProcess:Z
...
.method public hasPermission(Landroid/hardware/usb/UsbAccessory;)Z
    ...
    iget-boolean v4, p0, Lcom/android/server/usb/UsbSettingsManager;->mDisablePermissionDialogs:Z
    ...
    :cond_2
    :try_start_1
    iget-object v4, p0, Lcom/android/server/usb/UsbSettingsManager;->mAccessoryPermissionMap:Ljava/util/HashMap;
...
.method public hasPermission(Landroid/hardware/usb/UsbDevice;)Z
    ...
    :cond_2
    :try_start_1
    iget-object v4, p0, Lcom/android/server/usb/UsbSettingsManager;->mDevicePermissionMap:Ljava/util/HashMap;
