...
.method static synthetic access$1000(Lcom/android/server/pm/KnoxTimeoutHandler;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/pm/KnoxTimeoutHandler;
...
.method static synthetic access$1202(Lcom/android/server/pm/KnoxTimeoutHandler;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/pm/KnoxTimeoutHandler;
    .param p1, "x1"    # I
...
.method static synthetic access$702(Lcom/android/server/pm/KnoxTimeoutHandler;J)J
    .locals 1
    .param p0, "x0"    # Lcom/android/server/pm/KnoxTimeoutHandler;
    .param p1, "x1"    # J
...
.method static synthetic access$800(Lcom/android/server/pm/KnoxTimeoutHandler;)Lcom/android/server/pm/PersonaManagerService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/pm/KnoxTimeoutHandler;
...
.method static synthetic access$900(Lcom/android/server/pm/KnoxTimeoutHandler;)Lcom/android/server/wm/WindowManagerService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/pm/KnoxTimeoutHandler;
...
.method private declared-synchronized handleActiveUserChange(Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;)V
    ...
    .line 231
    .local v5, "userId":I
    const-string v6, "KnoxTimeoutHandler"
    ...
    const-string v8, " active change for "
    ...
    invoke-virtual {v6, v7, v5}, Lcom/android/server/pm/PersonaManagerService;->inState(Landroid/content/pm/PersonaState;I)Z
    ...
    const-string v8, " reset timeout from active user change. The time difference is "
    ...
    invoke-virtual {v6, v5}, Lcom/android/server/pm/PersonaManagerService;->getPersonaInfo(I)Landroid/content/pm/PersonaInfo;
    ...
    const-string v8, " is removed, no locking needed"
    ...
    const-string v8, " isUserHasTrust "
    ...
    const-string v8, " container is locked "
    ...
    const-string v7, "Do not show knox security screen cause it has FLAG_SHOW_WHEN_LOCKED but hide if needed"
    ...
    invoke-virtual {v6}, Lcom/android/server/pm/PersonaManagerService;->isKnoxMultiWindowExist()Z
    ...
    const-string v8, "Shared devices show user state"
    ...
    const-string v8, "Shared devices flag "
    ...
    invoke-virtual {v6, v7, v8}, Lcom/android/server/pm/PersonaManagerService;->inState(Landroid/content/pm/PersonaState;I)Z
    ...
    const-string v8, "Target Activity is not fullscreen. We will not show this activity"
