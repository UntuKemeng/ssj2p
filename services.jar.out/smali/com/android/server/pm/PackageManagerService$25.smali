...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ILandroid/content/pm/IPackageDataObserver;)V
    ...
    iput p3, p0, Lcom/android/server/pm/PackageManagerService$25;->val$userId:I

    iput-object p4, p0, Lcom/android/server/pm/PackageManagerService$25;->val$observer:Landroid/content/pm/IPackageDataObserver;
...
.method public run()V
    ...
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$25;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService$25;->val$packageName:Ljava/lang/String;

    iget v10, p0, Lcom/android/server/pm/PackageManagerService$25;->val$userId:I

    # invokes: Lcom/android/server/pm/PackageManagerService;->deleteApplicationCacheFilesLI(Ljava/lang/String;I)Z
    invoke-static {v7, v9, v10}, Lcom/android/server/pm/PackageManagerService;->access$7000(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;I)Z
    ...
    iget-object v8, p0, Lcom/android/server/pm/PackageManagerService$25;->val$packageName:Ljava/lang/String;

    iget v9, p0, Lcom/android/server/pm/PackageManagerService$25;->val$userId:I

    const/4 v10, 0x0

    # invokes: Lcom/android/server/pm/PackageManagerService;->clearExternalStorageDataSync(Ljava/lang/String;IZ)V
    invoke-static {v7, v8, v9, v10}, Lcom/android/server/pm/PackageManagerService;->access$6900(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;IZ)V
    ...
    iget v7, p0, Lcom/android/server/pm/PackageManagerService$25;->val$userId:I
    ...
    :cond_0
    :goto_0
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$25;->val$observer:Landroid/content/pm/IPackageDataObserver;
    ...
    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService$25;->val$observer:Landroid/content/pm/IPackageDataObserver;
