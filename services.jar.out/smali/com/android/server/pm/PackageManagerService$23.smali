...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ILandroid/content/pm/IPackageDataObserver;)V
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageManagerService$23;->val$packageName:Ljava/lang/String;

    iput p3, p0, Lcom/android/server/pm/PackageManagerService$23;->val$userId:I

    iput-object p4, p0, Lcom/android/server/pm/PackageManagerService$23;->val$observer:Landroid/content/pm/IPackageDataObserver;
...
.method public run()V
    ...
    .line 21185
    iget-object v8, p0, Lcom/android/server/pm/PackageManagerService$23;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v10, p0, Lcom/android/server/pm/PackageManagerService$23;->val$packageName:Ljava/lang/String;

    iget v11, p0, Lcom/android/server/pm/PackageManagerService$23;->val$userId:I

    # invokes: Lcom/android/server/pm/PackageManagerService;->clearApplicationUserDataLI(Ljava/lang/String;I)Z
    invoke-static {v8, v10, v11}, Lcom/android/server/pm/PackageManagerService;->access$6800(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;I)Z
    ...
    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService$23;->val$packageName:Ljava/lang/String;

    iget v10, p0, Lcom/android/server/pm/PackageManagerService$23;->val$userId:I

    const/4 v11, 0x1

    # invokes: Lcom/android/server/pm/PackageManagerService;->clearExternalStorageDataSync(Ljava/lang/String;IZ)V
    invoke-static {v8, v9, v10, v11}, Lcom/android/server/pm/PackageManagerService;->access$6900(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;IZ)V
    ...
    iget v8, p0, Lcom/android/server/pm/PackageManagerService$23;->val$userId:I
    ...
    :cond_1
    iget-object v8, p0, Lcom/android/server/pm/PackageManagerService$23;->val$observer:Landroid/content/pm/IPackageDataObserver;
    ...
    iget-object v10, p0, Lcom/android/server/pm/PackageManagerService$23;->val$observer:Landroid/content/pm/IPackageDataObserver;
