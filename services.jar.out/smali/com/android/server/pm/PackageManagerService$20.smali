...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;ILjava/lang/String;ILandroid/content/pm/IPackageDeleteObserver2;)V
    ...
    iput-object p3, p0, Lcom/android/server/pm/PackageManagerService$20;->val$packageName:Ljava/lang/String;

    iput p4, p0, Lcom/android/server/pm/PackageManagerService$20;->val$flags:I

    iput-object p5, p0, Lcom/android/server/pm/PackageManagerService$20;->val$observer:Landroid/content/pm/IPackageDeleteObserver2;
...
.method public run()V
    ...
    iget-object v6, p0, Lcom/android/server/pm/PackageManagerService$20;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v8, p0, Lcom/android/server/pm/PackageManagerService$20;->val$packageName:Ljava/lang/String;
    ...
    iget v6, p0, Lcom/android/server/pm/PackageManagerService$20;->val$flags:I
    ...
    iget-object v6, p0, Lcom/android/server/pm/PackageManagerService$20;->val$packageName:Ljava/lang/String;
    ...
    :cond_2
    iget v7, p0, Lcom/android/server/pm/PackageManagerService$20;->val$userId:I

    invoke-static {v6, v4, v7}, Lcom/android/server/pm/PmHook;->uninstallLog(Ljava/lang/String;ZI)V

    iget-object v4, p0, Lcom/android/server/pm/PackageManagerService$20;->val$observer:Landroid/content/pm/IPackageDeleteObserver2;
    ...
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$20;->val$observer:Landroid/content/pm/IPackageDeleteObserver2;
    ...
    :cond_3
    :goto_1
    iget-object v4, p0, Lcom/android/server/pm/PackageManagerService$20;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$20;->val$packageName:Ljava/lang/String;

    iget v8, p0, Lcom/android/server/pm/PackageManagerService$20;->val$userId:I

    iget v9, p0, Lcom/android/server/pm/PackageManagerService$20;->val$flags:I

    # invokes: Lcom/android/server/pm/PackageManagerService;->deletePackageX(Ljava/lang/String;II)I
    invoke-static {v6, v7, v8, v9}, Lcom/android/server/pm/PackageManagerService;->access$6500(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;II)I
