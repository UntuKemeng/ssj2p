...
.method private retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;IIIZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    .local v33, "r":Lcom/android/server/am/ServiceRecord;
    ...
    invoke-static {v5}, Landroid/os/PersonaManager;->isKnoxVersionSupported(Landroid/os/PersonaManager$KnoxContainerVersion;)Z
    ...
    .local v27, "component":Ljava/lang/String;
    ...
    .local v24, "callingUser":I
    const/16 v22, 0x0

    .local v22, "bypassHandleIncomingUser":Z
    ...
    .local v30, "ekm":Lcom/sec/enterprise/knox/EnterpriseKnoxManager;
    :try_start_0
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v5, v1}, Lcom/sec/enterprise/knox/EnterpriseKnoxManager;->getKnoxContainerManager(Landroid/content/Context;I)Lcom/sec/enterprise/knox/container/KnoxContainerManager;

    move-result-object v28

    .local v28, "containerMgr":Lcom/sec/enterprise/knox/container/KnoxContainerManager;
    if-eqz v28, :cond_1

    invoke-virtual/range {v28 .. v28}, Lcom/sec/enterprise/knox/container/KnoxContainerManager;->getContainerConfigurationPolicy()Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;

    move-result-object v25

    .local v25, "ccp":Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;
    invoke-virtual/range {v25 .. v25}, Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;->isBluetoothEnabled()Z
    :try_end_0
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0

    move-result v22

    .end local v25    # "ccp":Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;
    .end local v28    # "containerMgr":Lcom/sec/enterprise/knox/container/KnoxContainerManager;
    .end local v30    # "ekm":Lcom/sec/enterprise/knox/EnterpriseKnoxManager;
    :cond_1
    :goto_0
    if-nez v22, :cond_2
    ...
    .end local v22    # "bypassHandleIncomingUser":Z
    .end local v24    # "callingUser":I
    .end local v26    # "comp":Landroid/content/ComponentName;
    .end local v27    # "component":Ljava/lang/String;
    :cond_2
    :goto_1
    invoke-virtual/range {p1 .. p1}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;
    ...
    .restart local v26    # "comp":Landroid/content/ComponentName;
    ...
    .local v23, "callee":Ljava/lang/String;
    if-eqz v26, :cond_4
    ...
    .end local v23    # "callee":Ljava/lang/String;
    .end local v33    # "r":Lcom/android/server/am/ServiceRecord;
    .local v4, "r":Lcom/android/server/am/ServiceRecord;
    :goto_3
    return-object v5

    .end local v4    # "r":Lcom/android/server/am/ServiceRecord;
    .end local v21    # "bbcId":I
    .restart local v22    # "bypassHandleIncomingUser":Z
    .restart local v24    # "callingUser":I
    .restart local v27    # "component":Ljava/lang/String;
    .restart local v30    # "ekm":Lcom/sec/enterprise/knox/EnterpriseKnoxManager;
    .restart local v33    # "r":Lcom/android/server/am/ServiceRecord;
    :catch_0
    move-exception v29
    ...
    .restart local v21    # "bbcId":I
    .restart local v23    # "callee":Ljava/lang/String;
    .restart local v26    # "comp":Landroid/content/ComponentName;
    :cond_4
    ...
    :cond_5
    invoke-static/range {v21 .. v21}, Landroid/os/PersonaManager;->isBBCContainer(I)Z
    ...
    .restart local v33    # "r":Lcom/android/server/am/ServiceRecord;
    :cond_8
    invoke-static/range {p6 .. p6}, Landroid/os/PersonaManager;->isBBCContainer(I)Z
    ...
    iget-object v10, v9, Landroid/content/pm/ServiceInfo;->processName:Ljava/lang/String;
    ...
    iget v14, v9, Landroid/content/pm/ServiceInfo;->flags:I
    ...
    :cond_d
    new-instance v35, Landroid/content/pm/ServiceInfo;
    ...
    .end local v9    # "sInfo":Landroid/content/pm/ServiceInfo;
    .local v35, "sInfo":Landroid/content/pm/ServiceInfo;
    move-object/from16 v0, p0
    ...
    .end local v35    # "sInfo":Landroid/content/pm/ServiceInfo;
    :cond_e
    move-object/from16 v0, v36
    ...
    .local v37, "stats":Lcom/android/internal/os/BatteryStatsImpl;
    monitor-enter v37
    :try_end_3
    .catch Landroid/os/RemoteException; {:try_start_3 .. :try_end_3} :catch_1
    ...
    check-cast v32, Lcom/android/server/am/ServiceRecord;

    .local v32, "pr":Lcom/android/server/am/ServiceRecord;
    ...
    .end local v4    # "r":Lcom/android/server/am/ServiceRecord;
    .end local v31    # "i":I
    .end local v32    # "pr":Lcom/android/server/am/ServiceRecord;
    .restart local v33    # "r":Lcom/android/server/am/ServiceRecord;
    :catchall_0
    move-exception v5
    ...
    .end local v37    # "stats":Lcom/android/internal/os/BatteryStatsImpl;
    :catch_1
    move-exception v5
    ...
    const-string/jumbo v13, "not exported from uid "
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    ...
    .local v25, "clientLabel":I
    const/16 v24, 0x0

    .local v24, "clientIntent":Landroid/app/PendingIntent;
    ...
    iget v7, v0, Lcom/android/server/am/ProcessRecord;->setSchedGroup:I
    ...
    .local v31, "s":Lcom/android/server/am/ServiceRecord;
    ...
    invoke-virtual {v6, v7, v8}, Lcom/android/server/am/MARsPolicyManager;->handleSpecialBindServiceActions(Ljava/lang/String;Ljava/lang/String;)V

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/server/am/ActiveServices;->mAm:Lcom/android/server/am/ActivityManagerService;

    iget-object v4, v6, Lcom/android/server/am/ActivityManagerService;->mMARsPolicyManager:Lcom/android/server/am/MARsPolicyManager;
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/am/ServiceRecord;->hasAutoCreateConnections()Z

    move-result v6

    if-nez v6, :cond_a

    invoke-virtual/range {v31 .. v31}, Lcom/android/server/am/ServiceRecord;->getTracker()Lcom/android/internal/app/ProcessStats$ServiceState;

    move-result-object v32

    .local v32, "stracker":Lcom/android/internal/app/ProcessStats$ServiceState;
    if-eqz v32, :cond_a
    ...
    .end local v32    # "stracker":Lcom/android/internal/app/ProcessStats$ServiceState;
    :cond_a
    move-object/from16 v0, p0
    ...
    sget-boolean v6, Lcom/android/server/am/DynamicHiddenApp;->DEBUG_Component:Z
    ...
    iget-object v13, v6, Lcom/android/server/am/ActivityManagerService;->mDynamicHiddenApp:Lcom/android/server/am/DynamicHiddenApp;
    ...
    :goto_7
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/am/ServiceRecord;->toString()Ljava/lang/String;

    move-result-object v20

    invoke-virtual/range {v13 .. v20}, Lcom/android/server/am/DynamicHiddenApp;->dumpComponent(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;ILjava/lang/String;)V

    :cond_16
    sget-boolean v6, Lcom/android/server/am/DynamicHiddenApp;->DHA_HOTNESS_ENABLE:Z
    ...
    invoke-virtual {v6, v7, v0}, Lcom/android/server/am/DynamicHiddenApp;->setCallerHotnessAdj(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ProcessRecord;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    .end local v30    # "res":Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    .end local v31    # "s":Lcom/android/server/am/ServiceRecord;
    :catch_1
    move-exception v6
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;ILandroid/os/IBinder;I)Landroid/content/ComponentName;
    ...
    .prologue
    const-string v4, "com.google.android.location.reporting.ACTION_INSISTENT_SYNC"
    ...
    const-string v4, "com.sec.GMS_bundling"

    move-object/from16 v0, v24

    invoke-direct {v0, v4}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v24, "mIntentGmsBundlingCtl":Landroid/content/Intent;
    const-string/jumbo v4, "reportingEnabled"
    ...
    .end local v24    # "mIntentGmsBundlingCtl":Landroid/content/Intent;
    :cond_0
    if-eqz p1, :cond_5
    ...
    .restart local v24    # "mIntentGmsBundlingCtl":Landroid/content/Intent;
    :cond_1
    const-string/jumbo v4, "reportingEnabled"
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/ServiceRecord;->makeNextStartId()I
    ...
    iget-object v13, v4, Lcom/android/server/am/ActivityManagerService;->mDynamicHiddenApp:Lcom/android/server/am/DynamicHiddenApp;
    ...
    iget v0, v4, Lcom/android/server/am/ProcessRecord;->hotnessAdj:I

    move/from16 v16, v0

    const-string v17, "Serv"
    ...
    :goto_6
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/ServiceRecord;->toString()Ljava/lang/String;
    ...
    invoke-virtual/range {v13 .. v18}, Lcom/android/server/am/ActiveServices;->startServiceInnerLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Landroid/content/Intent;Lcom/android/server/am/ServiceRecord;ZZ)Landroid/content/ComponentName;
...
.method unbindFinishedLocked(Lcom/android/server/am/ServiceRecord;Landroid/content/Intent;Z)V
    ...
    iget v10, v1, Lcom/android/server/am/ProcessRecord;->setSchedGroup:I

    sget-boolean v8, Lcom/android/server/am/SchedPolicyManager;->ENABLE_CPUSET:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
