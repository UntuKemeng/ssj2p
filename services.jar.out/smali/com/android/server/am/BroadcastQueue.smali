...
.field private mHistoryDumpFile:Ljava/io/File;

.field private mHistoryDumpIndex:I

.field mHistoryNext:I

.field private mHistoryToFile:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;Ljava/lang/String;JZI)V
    ...
    iput-boolean v3, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryToFile:Z

    iput v3, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpIndex:I

    iput-object v4, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpFile:Ljava/io/File;
...
.method private final addBroadcastToHistoryLocked(Lcom/android/server/am/BroadcastRecord;)V
    ...
    :cond_4
    iget-boolean v3, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryToFile:Z

    if-eqz v3, :cond_0

    invoke-direct {p0, p1}, Lcom/android/server/am/BroadcastQueue;->addHistoryToFileLocked(Lcom/android/server/am/BroadcastRecord;)V
...
.method private final addHistoryToFileLocked(Lcom/android/server/am/BroadcastRecord;)V
    .locals 13
    .param p1, "r"    # Lcom/android/server/am/BroadcastRecord;
    ...
    invoke-direct {p0}, Lcom/android/server/am/BroadcastQueue;->getHistoryDumpFile()Ljava/io/File;
    ...
    iget v8, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpIndex:I
    ...
    invoke-virtual {p1, v7, v8, v9}, Lcom/android/server/am/BroadcastRecord;->dump(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/text/SimpleDateFormat;)V
    :try_end_3
    ...
    invoke-virtual {v7}, Ljava/io/PrintWriter;->checkError()Z
    ...
    const-string v10, "addHistoryToFile abort. PrintWriter flush error : "
    ...
    invoke-virtual {p0, v12}, Lcom/android/server/am/BroadcastQueue;->setBroadcastHistoryToFileLocked(Z)V
    ...
    iput v8, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpIndex:I
    ...
    const-string v10, "addHistoryToFile abort. FileOutputStream FNFE : "
    ...
    const-string v10, "addHistoryToFile abort. BufferedOutputStream IOE : "
    ...
    const-string v10, "addHistoryToFile abort. PrintWriter NPE : "
    ...
    invoke-virtual {p0, v8}, Lcom/android/server/am/BroadcastQueue;->setBroadcastHistoryToFileLocked(Z)V
    :try_end_5
    ...
    invoke-virtual {v6}, Ljava/io/PrintWriter;->checkError()Z
    ...
    const-string v11, "addHistoryToFile abort. PrintWriter flush error : "
    ...
    const-string v11, "addHistoryToFile abort. BufferedOutputStream IOE : "
...
.method private final getHistoryDumpFile()Ljava/io/File;
    .locals 5

    .prologue
    iget-object v3, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpFile:Ljava/io/File;
    ...
    const-string v4, "broadcastlogs_"
    ...
    .local v1, "historyDumpFileName":Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpFile:Ljava/io/File;
...
.method private final processCurBroadcastLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v0, "com.tencent.mm.booter.NotifyReceiver"
    ...
    const-string v1, "dev.hongbaoservice.running"
...
.method final setBroadcastHistoryToFileLocked(Z)V
    .locals 2
    .param p1, "historyToFile"    # Z

    .prologue
    iput-boolean p1, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryToFile:Z

    const/4 v1, 0x0

    iput v1, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpIndex:I

    if-nez p1, :cond_1

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/am/BroadcastQueue;->mHistoryDumpFile:Ljava/io/File;
