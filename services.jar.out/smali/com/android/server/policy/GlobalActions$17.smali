...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {}, Lcom/android/server/policy/GlobalActions;->access$5200()Z
    ...
    invoke-static {v0}, Lcom/android/server/policy/GlobalActions;->access$5202(Z)Z
    ...
    invoke-static {v4}, Lcom/android/server/policy/GlobalActions;->access$5300(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$ToggleAction;
    ...
    invoke-static {v5}, Lcom/android/server/policy/GlobalActions;->access$5100(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$MyAdapter;
    ...
    invoke-static {v3, v4, v5, v0}, Lcom/android/server/policy/GlobalActions;->access$5400(Lcom/android/server/policy/GlobalActions;Lcom/android/server/policy/GlobalActions$Action;IZ)Landroid/view/View;
    ...
    invoke-static {v2}, Lcom/android/server/policy/GlobalActions;->access$5600(Lcom/android/server/policy/GlobalActions;)Landroid/widget/LinearLayout;
    ...
    # invokes: Lcom/android/server/policy/GlobalActions;->makeActionsItem(Lcom/android/server/policy/GlobalActions$Action;IZ)Landroid/view/View;
    invoke-static {v3, v4, v5, v1}, Lcom/android/server/policy/GlobalActions;->access$5400(Lcom/android/server/policy/GlobalActions;Lcom/android/server/policy/GlobalActions$Action;IZ)Landroid/view/View;
    ...
    invoke-static {v1}, Lcom/android/server/policy/GlobalActions;->access$5800(Lcom/android/server/policy/GlobalActions;)Ljava/util/ArrayList;

    move-result-object v1

    # getter for: Lcom/android/server/policy/GlobalActions;->mProKioskMenuPosition:I
    invoke-static {}, Lcom/android/server/policy/GlobalActions;->access$5700()I
    ...
    # getter for: Lcom/android/server/policy/GlobalActions;->mProKioskToggle:Lcom/android/server/policy/GlobalActions$ToggleAction;
    invoke-static {v3}, Lcom/android/server/policy/GlobalActions;->access$5300(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$ToggleAction;
