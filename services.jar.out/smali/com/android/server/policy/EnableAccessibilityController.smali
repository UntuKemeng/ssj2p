...
.method static synthetic access$200(Lcom/android/server/policy/EnableAccessibilityController;Landroid/content/Context;I)V
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/policy/EnableAccessibilityController;->turnOffTalkBackExclusiveOptions(Landroid/content/Context;I)V
...
.method static synthetic access$300(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .prologue
    invoke-static {p0, p1}, Lcom/android/server/policy/EnableAccessibilityController;->hasPackage(Landroid/content/Context;Ljava/lang/String;)Z
...
.method static synthetic access$400(Lcom/android/server/policy/EnableAccessibilityController;Landroid/content/Context;Ljava/lang/String;)V
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/policy/EnableAccessibilityController;->turnOnTalkback(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static canEnableAccessibilityViaGesture(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v3}, Lcom/android/server/policy/EnableAccessibilityController;->hasPackage(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/android/server/policy/EnableAccessibilityController;->isTalkBackEnabled(Landroid/content/Context;)Z
...
.method private enableAccessibility()V
    ...
    iget-object v0, v0, Lcom/android/server/policy/EnableAccessibilityController;->mContext:Landroid/content/Context;

    move-object/from16 v17, v0

    invoke-static/range {v17 .. v17}, Lcom/android/server/policy/EnableAccessibilityController;->getInstalledSpeakingAccessibilityServices(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/server/policy/EnableAccessibilityController;->mWindowManager:Landroid/view/IWindowManager;
    ...
    iget-object v0, v0, Lcom/android/server/policy/EnableAccessibilityController;->mUserManager:Landroid/os/UserManager;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/policy/EnableAccessibilityController;->turnOffTalkBackExclusiveOptions(Landroid/content/Context;I)V

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/policy/EnableAccessibilityController;->mOnAccessibilityEnabledCallback:Ljava/lang/Runnable;
    ...
    iget-object v0, v0, Lcom/android/server/policy/EnableAccessibilityController;->mAccessibilityManager:Landroid/view/accessibility/IAccessibilityManager;
...
.method private turnOffScreenReader(Landroid/content/Context;)V
    ...
    invoke-direct/range {p0 .. p1}, Lcom/android/server/policy/EnableAccessibilityController;->getEnabledServicesFromSettings(Landroid/content/Context;)Ljava/util/Set;
...
.method private turnOffTalkBackExclusiveOptions(Landroid/content/Context;I)V
    ...
    invoke-direct/range {p0 .. p1}, Lcom/android/server/policy/EnableAccessibilityController;->turnOffScreenReader(Landroid/content/Context;)V
    ...
    invoke-direct/range {p0 .. p1}, Lcom/android/server/policy/EnableAccessibilityController;->turnOffUniversalInput(Landroid/content/Context;)V
