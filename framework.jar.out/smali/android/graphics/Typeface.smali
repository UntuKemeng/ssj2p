...
.method private static getDualProfileId(Landroid/content/Context;)I
    .locals 6
    ...
    .local v1, "mUserManager":Landroid/os/UserManager;
    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroid/os/UserManager;->ismServiceExist()Z
    ...
    invoke-virtual {v1, v5}, Landroid/os/UserManager;->getProfiles(I)Ljava/util/List;
...
.method private static getFullFlipFont(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroid/graphics/Typeface;->isDualProfilePresent(Landroid/content/Context;)Z

    move-result v11

    if-eqz v11, :cond_e

    invoke-static {p0}, Landroid/graphics/Typeface;->getDualProfileId(Landroid/content/Context;)I
    ...
    invoke-direct {v2, v11}, Ljava/io/BufferedReader;-><init>(Ljava/io/Reader;)V
    :try_end_14
    .catch Ljava/io/FileNotFoundException; {:try_start_14 .. :try_end_14} :catch_1e
...
.method private static isDualProfilePresent(Landroid/content/Context;)Z
    .locals 6
    .param p0, "ctx"    # Landroid/content/Context;
