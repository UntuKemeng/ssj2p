...
.method public sendVolumeKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    .line 232
    const-string v6, "MediaSessionHelper"

    const-string v7, "Tried to send a null key event. Ignoring."
    ...
    .line 241
    .local v4, "isMute":Z
    const-string v8, "MediaSessionHelper"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "VolumeKeyEvent down:"
    ...
    .line 242
    sget-boolean v8, Landroid/media/session/MediaSessionLegacyHelper;->mAudioCoreVolumekeyLoggingEnabled:Z
    ...
    iget-object v8, p0, Landroid/media/session/MediaSessionLegacyHelper;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    const-string/jumbo v9, "isBikeMode"
    ...
    .line 283
    :cond_7
    iget-object v6, p0, Landroid/media/session/MediaSessionLegacyHelper;->mSessionManager:Landroid/media/session/MediaSessionManager;

    invoke-virtual {v6, v11, v1, v3}, Landroid/media/session/MediaSessionManager;->dispatchAdjustVolume(III)V
    ...
    invoke-virtual {v6, v11, v7, v3}, Landroid/media/session/MediaSessionManager;->dispatchAdjustVolume(III)V
