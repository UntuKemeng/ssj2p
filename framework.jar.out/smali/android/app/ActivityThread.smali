...
.field final mLaunchingActivities:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap",
            "<",
...
.field private mScreenContext:Landroid/app/ContextImpl;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/app/ActivityThread;->mLaunchingActivities:Landroid/util/ArrayMap;
...
.method private checkAppLockState(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    invoke-virtual {v0, v5}, Landroid/app/ActivityManager;->isAppLockedPackage(Ljava/lang/String;)Z
    ...
    const-string v9, "AppLock checkAppLockState isAppLocked = "
    ...
    const-string v9, " showWhenLocked = "
    ...
    invoke-virtual {v0, v5}, Landroid/app/ActivityManager;->isAppLockedVerifying(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-virtual {v0, v5, v10}, Landroid/app/ActivityManager;->setAppLockedVerifying(Ljava/lang/String;Z)V

    new-instance v2, Landroid/content/Intent;

    const-string v7, "com.samsung.android.intent.action.CHECK_APPLOCK_SERVICE"
    ...
    invoke-virtual {v2, v7}, Landroid/content/Intent;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    const-string v7, "LOCKED_PACKAGE_INTENT"
    ...
    const-string v7, "LOCKED_PACKAGE_WINDOW_ATTRIBUTES"
    ...
    iget-object v7, p1, Landroid/app/ActivityThread$ActivityClientRecord;->parent:Landroid/app/Activity;
    ...
    const-string v9, "AppLock verify multiwindow = "
    ...
    const-string v7, "LOCKED_PACKAGE_MULTIWINDOWSTYLE"
    ...
    invoke-virtual {v7, v2}, Landroid/app/ContextImpl;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    iput-boolean v12, p0, Landroid/app/ActivityThread;->mSomeActivitiesChanged:Z
    ...
    iput-boolean v12, v8, Landroid/app/Activity;->mChangingConfigurations:Z
    ...
    invoke-virtual {p0, v8, v11, v9}, Landroid/app/ActivityThread;->performPauseActivity(Landroid/os/IBinder;ZZ)Landroid/os/Bundle;
    ...
    invoke-direct {p0, v8, v11, v2, v12}, Landroid/app/ActivityThread;->handleDestroyActivity(Landroid/os/IBinder;ZIZ)V
    ...
    iput-boolean v11, v6, Landroid/app/ActivityThread$ActivityClientRecord;->hideForNow:Z
...
.method private parseCSCAppResource()V
    ...
    iput-object v11, p0, Landroid/app/ActivityThread;->mCSCIconMap:Landroid/util/ArrayMap;

    new-instance v11, Landroid/util/ArrayMap;

    invoke-direct {v11}, Landroid/util/ArrayMap;-><init>()V

    iput-object v11, p0, Landroid/app/ActivityThread;->mCSCStringMap:Landroid/util/ArrayMap;
    ...
    const-string v12, "/appresource/CSCAppResource.xml"
    ...
    iget-object v11, p0, Landroid/app/ActivityThread;->mCSCIconMap:Landroid/util/ArrayMap;

    invoke-virtual {v11}, Landroid/util/ArrayMap;->clear()V

    iget-object v11, p0, Landroid/app/ActivityThread;->mCSCStringMap:Landroid/util/ArrayMap;
    ...
    const-string/jumbo v12, "iconid"

    invoke-interface {v3, v11, v12}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .local v4, "strIconId":Ljava/lang/String;
    const/4 v11, 0x0

    const-string/jumbo v12, "stringid"
    ...
    .local v6, "strStringId":Ljava/lang/String;
    if-eqz v5, :cond_1
    ...
    .end local v4    # "strIconId":Ljava/lang/String;
    .end local v5    # "strName":Ljava/lang/String;
    .end local v6    # "strStringId":Ljava/lang/String;
    ...
    .restart local v1    # "file":Ljava/io/File;
    .restart local v2    # "omcPath":Ljava/lang/String;
    :cond_4
    :try_start_3
    new-instance v1, Ljava/io/File;

    .end local v1    # "file":Ljava/io/File;
    const-string v11, "/system/csc/appresource/CSCAppResource.xml"
    ...
    .restart local v4    # "strIconId":Ljava/lang/String;
    .restart local v5    # "strName":Ljava/lang/String;
    .restart local v6    # "strStringId":Ljava/lang/String;
    ...
    const-string/jumbo v12, "parseCSCAppResource: Got exception:"
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iget v4, v0, Landroid/app/ActivityThread$ActivityClientRecord;->displayId:I

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v1, v2, v4}, Landroid/app/ActivityThread;->createBaseContextForActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/Activity;I)Landroid/content/Context;
...
.method private updateDefaultDensity()V
    ...
    invoke-static {v0}, Landroid/content/res/Resources;->setLoadDensityDpi(I)V
...
.method private updatePackageInfos(Landroid/util/ArrayMap;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v8, v9, v10, v11}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    :try_end_5
    ...
    const-string v11, "Resetting overlays for "
    ...
    iget-object v8, v1, Landroid/content/pm/ApplicationInfo;->resourceDirs:[Ljava/lang/String;
    ...
    invoke-virtual {v4, v8}, Landroid/app/LoadedApk;->setOverlayDirs([Ljava/lang/String;)V
...
.method private updatePackageInfosIfNeeded(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    .locals 0
    .param p1, "config"    # Landroid/content/res/Configuration;
...
.method private updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    invoke-static {p1}, Landroid/app/ActivityThread$ActivityClientRecord;->access$4400(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
...
.method public final applyConfigurationToResources(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/app/ActivityThread;->updatePackageInfosIfNeeded(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
...
.method public dumpThread(Ljava/io/PrintWriter;Ljava/lang/String;ZZ)V
    ...
    const-string/jumbo v3, "mCurDefaultDisplayDpis"

    invoke-virtual {p0, v1, v3, p1, v0}, Landroid/app/ActivityThread;->dumpIntArrayList(Ljava/util/ArrayList;Ljava/lang/String;Ljava/io/PrintWriter;Ljava/lang/String;)V

    iget-object v1, p0, Landroid/app/ActivityThread;->mConfigurations:Lcom/samsung/android/multidisplay/common/UnRestrictedArrayList;

    const-string/jumbo v3, "mConfigurations"

    invoke-virtual {p0, v1, v3, p1, v0}, Landroid/app/ActivityThread;->dumpObjArrayList(Ljava/util/ArrayList;Ljava/lang/String;Ljava/io/PrintWriter;Ljava/lang/String;)V

    iget-object v1, p0, Landroid/app/ActivityThread;->mCompatConfigurations:Lcom/samsung/android/multidisplay/common/UnRestrictedArrayList;

    const-string/jumbo v3, "mCompatConfigurations"
    ...
    const-string/jumbo v3, "mPendingConfigurations"
...
.method public getScreenContext()Landroid/app/ContextImpl;
    .locals 1
    ...
    :try_start_0
    iget-object v0, p0, Landroid/app/ActivityThread;->mScreenContext:Landroid/app/ContextImpl;

    if-nez v0, :cond_0

    invoke-static {p0}, Landroid/app/ContextImpl;->createScreenContext(Landroid/app/ActivityThread;)Landroid/app/ContextImpl;

    move-result-object v0

    iput-object v0, p0, Landroid/app/ActivityThread;->mScreenContext:Landroid/app/ContextImpl;
...
.method final handleActivityConfigurationChanged(Landroid/app/ActivityThread$ActivityConfigChangeData;)V
    ...
    .local v0, "compatConfiguration":Landroid/content/res/Configuration;
    # getter for: Landroid/app/ActivityThread$ActivityClientRecord;->tmpConfig:Landroid/content/res/Configuration;
    invoke-static {v3}, Landroid/app/ActivityThread$ActivityClientRecord;->access$4400(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
    ...
    iget-object v5, p1, Landroid/app/ActivityThread$ActivityConfigChangeData;->overrideConfig:Landroid/content/res/Configuration;
    ...
    .end local v1    # "nextOverrideOr":I
    .end local v2    # "prevOverrideOr":I
    :cond_2
    iget-object v4, v3, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    invoke-static {v4, v5}, Landroid/app/ActivityThread;->performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V
    ...
    .restart local v1    # "nextOverrideOr":I
    :cond_3
    const/4 v2, 0x0
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;IIZ)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/app/ActivityThread;->updatePackageInfosIfNeeded(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    # getter for: Landroid/app/ActivityThread$ActivityClientRecord;->tmpConfig:Landroid/content/res/Configuration;
    invoke-static {v4}, Landroid/app/ActivityThread$ActivityClientRecord;->access$4400(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
...
.method public final requestRelaunchActivity(Landroid/os/IBinder;Ljava/util/List;Ljava/util/List;IZLandroid/content/res/Configuration;Landroid/content/res/Configuration;ZLcom/samsung/android/multiwindow/MultiWindowStyle;I)V
    ...
    iput-object p7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->overrideConfig:Landroid/content/res/Configuration;
