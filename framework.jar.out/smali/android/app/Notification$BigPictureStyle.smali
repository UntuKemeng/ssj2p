...
.method private makeBigContentView()Landroid/widget/RemoteViews;
    ...
    invoke-static {v3}, Landroid/app/Notification$Builder;->access$1600(Landroid/app/Notification$Builder;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v3, v4}, Landroid/app/Notification$Builder;->access$1602(Landroid/app/Notification$Builder;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;

    :cond_0
    iget-object v3, p0, Landroid/app/Notification$BigPictureStyle;->mBuilder:Landroid/app/Notification$Builder;

    # invokes: Landroid/app/Notification$Builder;->getBigPictureLayoutResource()I
    invoke-static {v3}, Landroid/app/Notification$Builder;->access$1700(Landroid/app/Notification$Builder;)I
    ...
    # setter for: Landroid/app/Notification$Builder;->mLargeIcon:Landroid/graphics/drawable/Icon;
    invoke-static {v3, v1}, Landroid/app/Notification$Builder;->access$1602(Landroid/app/Notification$Builder;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v3}, Landroid/app/Notification$Builder;->access$1200(Landroid/app/Notification$Builder;)Ljava/lang/CharSequence;
    ...
    invoke-static {v4, v0, v3}, Landroid/app/Notification$Builder;->access$1900(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;I)Z
