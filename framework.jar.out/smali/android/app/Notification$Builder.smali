...
.method static synthetic access$1002(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 0
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$1100(Landroid/app/Notification$Builder;I)Landroid/widget/RemoteViews;
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
    .param p1, "x1"    # I
...
.method static synthetic access$1300(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
    .param p1, "x1"    # Ljava/lang/CharSequence;
...
.method static synthetic access$1400(Landroid/app/Notification$Builder;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$1500(Landroid/app/Notification$Builder;)Z
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$1600(Landroid/app/Notification$Builder;)Landroid/graphics/drawable/Icon;
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$1602(Landroid/app/Notification$Builder;Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
    .locals 0
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$1900(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;I)Z
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$2100(Landroid/app/Notification$Builder;)I
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$2200(Landroid/app/Notification$Builder;Landroid/widget/RemoteViews;)V
    .locals 0
    .param p0, "x0"    # Landroid/app/Notification$Builder;
    .param p1, "x1"    # Landroid/widget/RemoteViews;
...
.method static synthetic access$2300(Landroid/app/Notification$Builder;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method static synthetic access$2600(Landroid/app/Notification$Builder;IZ)Landroid/widget/RemoteViews;
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
...
.method static synthetic access$2800(Landroid/app/Notification$Builder;)Z
    .locals 1
    .param p0, "x0"    # Landroid/app/Notification$Builder;
...
.method private applyStandardTemplate(IZ)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v13, v3}, Landroid/content/res/Resources;->getStringNames(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v16

    .local v16, "stringName":Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    .end local v16    # "stringName":Ljava/lang/CharSequence;
    :cond_0
    move-object/from16 v0, p0
    ...
    # getter for: Landroid/app/Notification;->mSquarcleNotiIconStyle:Z
    invoke-static {}, Landroid/app/Notification;->access$400()Z
    ...
    invoke-direct {v0, v3}, Landroid/app/Notification$Builder;->cutLargeIcon(Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
    ...
    invoke-virtual {v2, v3, v12}, Landroid/widget/RemoteViews;->setImageViewIcon(ILandroid/graphics/drawable/Icon;)V

    .end local v12    # "largeIcon":Landroid/graphics/drawable/Icon;
    :goto_0
    move-object/from16 v0, p0
...
.method private cutLargeIcon(Landroid/graphics/drawable/Icon;)Landroid/graphics/drawable/Icon;
    .locals 18
    ...
    invoke-virtual {v0, v14}, Landroid/graphics/drawable/Icon;->loadDrawable(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .end local p1    # "largeIcon":Landroid/graphics/drawable/Icon;
    :cond_0
    :goto_0
    return-object p1

    .restart local p1    # "largeIcon":Landroid/graphics/drawable/Icon;
    :cond_1
    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Landroid/app/Notification$Builder;->drawableToBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;

    move-result-object v8

    .local v8, "original":Landroid/graphics/Bitmap;
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v14}, Landroid/app/Notification$Builder;->drawableToBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, v8}, Landroid/app/Notification$Builder;->shouldScale(Landroid/graphics/Bitmap;)Z

    move-result v7

    .local v7, "needScale":Z
    ...
    const-wide v16, 0x3fe9eb851eb851ecL    # 0.81
    ...
    .local v11, "resizedOriginal":Landroid/graphics/Bitmap;
    invoke-virtual {v5}, Landroid/graphics/Bitmap;->getWidth()I
    ...
    sget-object v15, Landroid/graphics/PorterDuff$Mode;->DST_ATOP:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {v14, v15}, Landroid/graphics/PorterDuffXfermode;-><init>(Landroid/graphics/PorterDuff$Mode;)V

    invoke-virtual {v10, v14}, Landroid/graphics/Paint;->setXfermode(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;
    ...
    invoke-virtual {v2, v11, v14, v15, v10}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V

    const/4 v14, 0x0

    const/4 v15, 0x0

    invoke-virtual {v2, v5, v14, v15, v10}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    .end local v11    # "resizedOriginal":Landroid/graphics/Bitmap;
...
.method public static rebuild(Landroid/content/Context;Landroid/app/Notification;)Landroid/app/Notification;
    ...
    const-string v6, "No Error. NPE in Notification.rebuild(Context, Notification)"
...
.method private shouldScale(Landroid/graphics/Bitmap;)Z
    .locals 21
    ...
    invoke-virtual {v0, v12, v12}, Landroid/graphics/Bitmap;->getPixel(II)I
    ...
    invoke-virtual {v0, v12, v1}, Landroid/graphics/Bitmap;->getPixel(II)I
...
.method public buildUnstyled()Landroid/app/Notification;
    ...
    invoke-static {v0, v1}, Landroid/app/Notification;->access$902(Landroid/app/Notification;Ljava/util/Map;)Ljava/util/Map;
