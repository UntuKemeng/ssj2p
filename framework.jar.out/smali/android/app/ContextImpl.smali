...
.method private constructor <init>(Landroid/app/ContextImpl;Landroid/app/ActivityThread;Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/os/UserHandle;ZLandroid/view/Display;Landroid/content/res/Configuration;I)V
    ...
    invoke-virtual {p3, p2, v1}, Landroid/app/LoadedApk;->getResources(Landroid/app/ActivityThread;Landroid/os/UserHandle;)Landroid/content/res/Resources;
...
.method private bindServiceCommon(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    invoke-virtual {v0, p2, v1, v3, p3}, Landroid/app/LoadedApk;->getServiceDispatcher(Landroid/content/ServiceConnection;Landroid/content/Context;Landroid/os/Handler;I)Landroid/app/IServiceConnection;
    ...
    const-string v3, "Not allowed to bind to service "
...
.method static createActivityContext(Landroid/app/ActivityThread;Landroid/app/LoadedApk;ILandroid/content/res/Configuration;Landroid/os/IBinder;)Landroid/app/ContextImpl;
    .locals 10
...
.method static createScreenContext(Landroid/app/ActivityThread;)Landroid/app/ContextImpl;
    .locals 10
    .param p0, "mainThread"    # Landroid/app/ActivityThread;
    ...
    invoke-static {}, Landroid/content/res/Resources;->getScreenResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v2}, Landroid/app/ResourcesManager;->getConfigurationForScreen()Landroid/content/res/Configuration;
...
.method private startServiceCommon(Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/ComponentName;
    ...
    .line 1339
    .local v6, "aux":Landroid/content/ComponentName;
    if-eqz v6, :cond_1
    ...
    iget-object v9, p0, Landroid/app/ContextImpl;->mActivityToken:Landroid/os/IBinder;

    .line 1371
    .local v9, "parentActivityToken":Landroid/os/IBinder;
    invoke-static {}, Landroid/app/ActivityManagerNative;->getDefault()Landroid/app/IActivityManager;
    ...
    .line 1387
    .end local v6    # "aux":Landroid/content/ComponentName;
    .end local v7    # "cn":Landroid/content/ComponentName;
    .end local v9    # "parentActivityToken":Landroid/os/IBinder;
    :catch_0
    move-exception v8
    ...
    .restart local v6    # "aux":Landroid/content/ComponentName;
    .restart local v7    # "cn":Landroid/content/ComponentName;
    .restart local v9    # "parentActivityToken":Landroid/os/IBinder;
    :cond_2
    :try_start_1
    invoke-virtual {v7}, Landroid/content/ComponentName;->getPackageName()Ljava/lang/String;
...
.method public createDisplayContext(Landroid/view/Display;)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/ContextImpl;->createDisplayContext(Landroid/view/Display;Landroid/os/IBinder;)Landroid/content/Context;
...
.method public createDisplayContext(Landroid/view/Display;Landroid/os/IBinder;)Landroid/content/Context;
    .locals 10
    .param p1, "display"    # Landroid/view/Display;
...
.method public getShrinkRequested()Z
    ...
    invoke-virtual {v0}, Landroid/app/ActivityThread;->getShrinkRequested()Z
...
.method public getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 1506
    iget-object v4, p0, Landroid/app/ContextImpl;->mOuterContext:Landroid/content/Context;

    invoke-static {v4, v5}, Landroid/sec/enterprise/EnterpriseDeviceManager;->create(Landroid/content/Context;Landroid/os/Handler;)Ljava/lang/Object;
    ...
    .line 1507
    :cond_1
    const-string/jumbo v4, "knox_enterprise_policy"
    ...
    invoke-static {v4, v5}, Landroid/sec/enterprise/EnterpriseDeviceManager;->createKnox(Landroid/content/Context;Landroid/os/Handler;)Ljava/lang/Object;
    ...
    .line 1512
    .local v3, "registrySystemService":Ljava/lang/Object;
    if-nez v3, :cond_0
    ...
    const-string/jumbo v5, "getSystemService(): Sprint LTE"
    ...
    invoke-static {v4}, Landroid/app/ContextImpl;->getVzwLocationManager(Landroid/content/Context;)Ljava/lang/Object;
...
.method public setKeyguardPreview(I)V
    ...
    const-string v3, "failed to set setKeyguardPreview"
...
.method public setResources(Landroid/content/res/Resources;)V
    ...
    .line 2453
    invoke-virtual {p0}, Landroid/app/ContextImpl;->invalidateTheme()V
...
.method public setReverseStartingWindowContentView(I)V
    ...
    const-string v3, "failed to set ReverseStartingWindowContentView"
...
.method public setStartingWindowContentView(I)V
    ...
    const-string v3, "failed to set StartingWindowContentView"
