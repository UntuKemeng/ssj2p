...
.field public static final DUMP_CONTEXT_RELATION_INFO_TRANSACTION:I = 0xbbb
...
.field public static final FORCE_RESUME_ACTIVITY_TRANSACTION:I = 0xbcd
...
.field public static final RESET_TARGET_HEAP_UTILIZATION:I = 0x7d0
...
.field public static final SCHEDULE_APPLICATION_DISPLAY_ID_CHANGED_TRANSACTION:I = 0xbbe

.field public static final SCHEDULE_BIND_SERVICE_TRANSACTION:I = 0x14

.field public static final SCHEDULE_CONFIGURATIONS_CHANGED_TRANSACTION:I = 0xbbd
...
.field public static final SCHEDULE_CREATE_SERVICE_FOR_DUAL_SCREEN_TRANSACTION:I = 0xbbc
...
.field public static final SCHEDULE_DISPLAYMETRICS_CHANGED_TRANSACTION:I = 0x9c5
...
.field public static final SCHEDULE_MULTI_WINDOW_EXIT_BY_CLOSE_BTN_TRANSACTION:I = 0x3eb

.field public static final SCHEDULE_MULTI_WINDOW_FOCUS_CHANGED_TRANSACTION:I = 0x3ea

.field public static final SCHEDULE_MULTI_WINDOW_STYLE_CHANGED_TRANSACTION:I = 0x3e9
...
.field public static final SCHEDULE_SEND_EXPAND_REQUEST:I = 0xbc1

.field public static final SCHEDULE_SEND_RESULT_TRANSACTION:I = 0x6

.field public static final SCHEDULE_SEND_SHRINK_REQUEST:I = 0xbc0
...
.field public static final SET_SHRINK_REQUESTED_STATE:I = 0xbbf

.field public static final UNSTABLE_PROVIDER_DIED_TRANSACTION:I = 0x2f

.field public static final UPDATE_ASSET_OVERLAY_PATH:I = 0x7d1
...
.method public abstract forceCallResumeActivity(Landroid/os/IBinder;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleApplicationDisplayIdChanged(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleConfigurationsChanged(Lcom/samsung/android/multidisplay/common/UnRestrictedArrayList;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/samsung/android/multidisplay/common/UnRestrictedArrayList",
...
.method public abstract scheduleDisplayMetricsChanged(Landroid/view/DisplayInfo;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleMultiWindowExitByCloseBtn(Landroid/os/IBinder;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleMultiWindowFocusChanged(Landroid/os/IBinder;IZZ)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleMultiWindowStyleChanged(Landroid/os/IBinder;Lcom/samsung/android/multiwindow/MultiWindowStyle;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleRelaunchActivity(Landroid/os/IBinder;Ljava/util/List;Ljava/util/List;IZLandroid/content/res/Configuration;Landroid/content/res/Configuration;Lcom/samsung/android/multiwindow/MultiWindowStyle;I)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/os/IBinder;",
...
.method public abstract scheduleResetTargetHeapUtilization(Landroid/os/IBinder;Ljava/lang/String;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleSendExpandRequest(Landroid/os/IBinder;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract scheduleSendShrinkRequest(Landroid/os/IBinder;II)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setShrinkRequestedState(Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
