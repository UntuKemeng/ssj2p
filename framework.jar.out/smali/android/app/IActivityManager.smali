...
.field public static final AUTORUN_BLOCKED_APP:I = 0x4b4
...
.field public static final CHECK_KNOX_PERMISSION_BY_PID_TRANSACTION:I = 0x5de

.field public static final CHECK_KNOX_PERMISSION_BY_PKGNAME_TRANSACTION:I = 0x5dd
...
.field public static final ENABLE_SAFE_MODE_TRANSACTION:I = 0x1785
...
.field public static final GET_CONFIGURATION_BY_DISPLAYID_TRANSACTION:I = 0x1389
...
.field public static final GET_REQUESTED_ORIENTATION_BY_TASKID_TRANSACTION:I = 0x1786
...
.field public static final GET_SMPKGS_LIST:I = 0x4b3
...
.field public static final GET_TASKS_BY_DISPLAY_TRANSACTION:I = 0x138b
...
.field public static final IS_SNN_ENABLE:I = 0xfd5
...
.field public static final KEYGUARD_WAITING_FOR_ACTIVITY_DRAWN_TARGET_TRANSACTION:I = 0x44e
...
.field public static final MULTIWINDOW_MINIMIZE_TRANSITION:I = 0x3f5

.field public static final MULTIWINDOW_SETTING_CHANGED_TRANSACTION:I = 0x3f3
...
.field public static final NOTIFY_CASCADE_STACK_ROTATED:I = 0x3f7

.field public static final NOTIFY_CLEARTEXT_NETWORK_TRANSACTION:I = 0x119

.field public static final NOTIFY_DISPLAY_FREEZE_STOPPED_TRANSITION:I = 0x3f6
...
.field public static final REMOVE_DELETED_PACKAGE_TRANSACTION:I = 0xfd3
...
.field public static final SET_BACKWINDOW_SHOW_TRANSACTION:I = 0x138d
...
.field public static final SET_FOCUSED_STACK_BY_TAP_OUTSIDE_TRANSACTION:I = 0x3f4
...
.field public static final SET_SNN_ENABLE:I = 0xfd4
...
.field public static final SWITCH_STACK_TRANSACTION:I = 0x3f2
...
.field public static final UNFREEZE_APP:I = 0x4b2
...
.field public static final UPDATE_PROCESS_CONFIGURATION_TRANSACTION:I = 0x138c
...
.method public abstract enableSafeMode()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getConfiguration(I)Landroid/content/res/Configuration;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getSMpkgsList(Ljava/util/List;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
...
.method public abstract getTasks(III)Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(III)",
            "Ljava/util/List",
...
.method public abstract isAutoRunBlockedApp(Ljava/lang/String;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract isSNNEnable()I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract keyguardWaitingForActivityDrawnTarget(Landroid/content/Intent;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract notifyCascadeStackRotated(ILandroid/graphics/Rect;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract notifyDisplayFreezeStopped()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract notifyMinimizeMultiWindow(Landroid/os/IBinder;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract removeDeletedPkgsFromLru(Ljava/lang/String;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setBackWindowShown(Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setSNNEnable(Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract unFreezeApp(Ljava/lang/String;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract updateProcessConfiguration(IIZ)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
