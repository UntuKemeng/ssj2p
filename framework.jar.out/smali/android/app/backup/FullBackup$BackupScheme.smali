...
.method private maybeParseBackupSchemeLocked()V
    ...
    const-string v3, "android:fullBackupContent - \"true\""
    ...
    const-string v3, "android:fullBackupContent - found xml resource"
...
.method private parseCurrentTagForDomain(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Set;Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    const-string v4, "Invalid tag found in xml \""
    ...
    const-string v4, "\"; aborting operation."
    ...
    const-string v4, "Unrecognised tag in backup criteria xml ("
...
.method private validateInnerTagContents(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    const-string v2, "At most 2 tag attributes allowed for \""
    ...
    const-string v2, "\" tag (\"domain\" & \"path\"."
...
.method public parseBackupSchemeFromXmlLocked(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Set;Ljava/util/Map;)V
    ...
    :cond_0
    const-string v15, "full-backup-content"
    ...
    const-string v17, "Xml file didn\'t start with correct tag (<full-backup-content>). Found \""
    ...
    :cond_1
    const-string v15, "BackupXmlParserLogging"
    ...
    const-string v16, "Found valid fullBackupContent; parsing xml resource."
    ...
    const-string v17, "\" invalid; skipping"
    ...
    invoke-direct {v0, v7, v15}, Landroid/app/backup/FullBackup$BackupScheme;->extractCanonicalFile(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    const-string v17, "...automatically generated "
    ...
    const-string v17, ". Ignore if nonexistant."
    ...
    const-string v16, "Xml resource parsing complete."

    invoke-static/range {v15 .. v16}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    const-string v15, "BackupXmlParserLogging"

    const-string v16, "Final tally."

    invoke-static/range {v15 .. v16}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    const-string v15, "BackupXmlParserLogging"

    const-string v16, "Includes:"
    ...
    const-string v16, "  ...nothing specified (This means the entirety of app data minus excludes)"
    ...
    const-string v16, "  ...nothing to exclude."
    ...
    const-string v16, "BackupXmlParserLogging"
    ...
    .local v11, "excludeData":Ljava/lang/String;
    const-string v15, "BackupXmlParserLogging"
