...
.method public doDeath(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    const-string v3, "Death for someone different than who we last reported. just ignore it. name="
    ...
    const-string/jumbo v3, "ignore old.binder="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, v0, Landroid/app/LoadedApk$ServiceDispatcher$ConnectionInfo;->binder:Landroid/os/IBinder;
