...
.field public static final DENSITY_SCALE_FACTOR_UNDEFINED:F = 0.0f
...
.field public static final UI_MODE_TYPE_KNOX_DESKTOP:I = 0x2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field
...
.field public densityScaleFactor:F
...
.field public mobileKeyboardCovered:I
...
.method public compareTo(Landroid/content/res/Configuration;)I
    ...
    iget v6, p1, Landroid/content/res/Configuration;->showButtonBackground:I
...
.method public diff(Landroid/content/res/Configuration;Z)I
    ...
    iget v3, p0, Landroid/content/res/Configuration;->mobileKeyboardCovered:I

    iget v4, p1, Landroid/content/res/Configuration;->mobileKeyboardCovered:I
    ...
    iget v3, p0, Landroid/content/res/Configuration;->showButtonBackground:I

    iget v4, p1, Landroid/content/res/Configuration;->showButtonBackground:I
...
.method public isStackOverrideConfig()Z
    .locals 3
    ...
    invoke-virtual {v2, p0}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    iput v0, p0, Landroid/content/res/Configuration;->densityScaleFactor:F
...
.method public setTo(Landroid/content/res/Configuration;)V
    ...
    iget v0, p1, Landroid/content/res/Configuration;->densityScaleFactor:F
...
.method public toString()Ljava/lang/String;
    ...
    :goto_7
    iget v2, p0, Landroid/content/res/Configuration;->densityScaleFactor:F
...
.method public updateFrom(Landroid/content/res/Configuration;)I
    ...
    :cond_1b
    iget v2, p1, Landroid/content/res/Configuration;->densityScaleFactor:F
    ...
    iget v3, p1, Landroid/content/res/Configuration;->densityScaleFactor:F
    ...
    iput v2, p0, Landroid/content/res/Configuration;->densityScaleFactor:F
...
.method public updateFromStackOverrideConfig(Landroid/content/res/Configuration;)I
    .locals 3
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v0, p0, Landroid/content/res/Configuration;->showButtonBackground:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    iget v0, p0, Landroid/content/res/Configuration;->densityScaleFactor:F
