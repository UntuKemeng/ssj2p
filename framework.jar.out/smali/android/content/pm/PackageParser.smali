...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/content/pm/PackageParser;->DEBUG_DCS:Z
...
.method public static generateApplicationInfo(Landroid/content/pm/PackageParser$Package;ILandroid/content/pm/PackageUserState;I)Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v2, v0, Landroid/content/pm/ApplicationInfo;->volumeUuid:Ljava/lang/String;

    iget-object v3, v0, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    invoke-static {v2, p3, v3}, Landroid/os/Environment;->getDataUserPackageDirectory(Ljava/lang/String;ILjava/lang/String;)Ljava/io/File;
...
.method public static generatePackageInfo(Landroid/content/pm/PackageParser$Package;[IIJJLjava/util/Set;Landroid/content/pm/PackageUserState;I)Landroid/content/pm/PackageInfo;
    ...
    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->splitNames:[Ljava/lang/String;

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->splitNames:[Ljava/lang/String;
    ...
    iget v15, v0, Landroid/content/pm/PackageParser$Package;->baseRevisionCode:I

    iput v15, v12, Landroid/content/pm/PackageInfo;->baseRevisionCode:I

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->splitRevisionCodes:[I

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->splitRevisionCodes:[I
    ...
    iget-boolean v15, v0, Landroid/content/pm/PackageParser$Package;->coreApp:Z

    iput-boolean v15, v12, Landroid/content/pm/PackageInfo;->coreApp:Z
    ...
    iget-boolean v15, v0, Landroid/content/pm/PackageParser$Package;->mRequiredForAllUsers:Z

    iput-boolean v15, v12, Landroid/content/pm/PackageInfo;->requiredForAllUsers:Z

    :cond_2
    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->mRestrictedAccountType:Ljava/lang/String;

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->restrictedAccountType:Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->mRequiredAccountType:Ljava/lang/String;

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->requiredAccountType:Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->mOverlayTarget:Ljava/lang/String;

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->overlayTarget:Ljava/lang/String;
    ...
    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->featureGroups:Ljava/util/ArrayList;
    ...
    new-array v15, v4, [Landroid/content/pm/FeatureGroupInfo;

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->featureGroups:[Landroid/content/pm/FeatureGroupInfo;

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->featureGroups:Ljava/util/ArrayList;

    iget-object v0, v12, Landroid/content/pm/PackageInfo;->featureGroups:[Landroid/content/pm/FeatureGroupInfo;
    ...
    .local v9, "mSTSHelper":Landroid/os/STSHelper;
    iget-object v15, v12, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v9, v15}, Landroid/os/STSHelper;->getSTSOption(Ljava/lang/String;)D

    move-result-wide v16

    move-wide/from16 v0, v16

    iput-wide v0, v12, Landroid/content/pm/PackageInfo;->stsOption:D

    goto/16 :goto_0

    .end local v9    # "mSTSHelper":Landroid/os/STSHelper;
    :cond_23
    const/4 v4, 0x0
...
.method public static getHashValueOfPackage(Ljava/io/File;Ljava/lang/StringBuilder;)V
    ...
    :try_end_3
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_3 .. :try_end_3} :catch_11
    ...
    invoke-direct {v10, v11, v12, v5}, Landroid/content/pm/PackageParser$PackageParserException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private getMonolithicApkPath(Ljava/io/File;)Ljava/lang/String;
    .locals 11
    ...
    const-string/jumbo v10, "list is null.. what happened to "
...
.method private static hasDomainURLs(Landroid/content/pm/PackageParser$Package;)Z
    ...
    const-string/jumbo v10, "hasDomainURLs:true for package:"
...
.method private parseActivity(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;ZZ)Landroid/content/pm/PackageParser$Activity;
    ...
    const-string v4, "CscFeature_Contact_ConfigOpStyleVariation"
    ...
    const-string v3, "changed label for DCM & KDDI"
    ...
    iput v3, v2, Landroid/content/pm/ActivityInfo;->labelRes:I
...
.method private parseBaseApk(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    :cond_a
    const-string v3, "com.samsung.felicaremotelock"
    ...
    :cond_b
    const-string v3, "com.samsung.nfcremotelock"
    ...
    :cond_c
    const-string/jumbo v3, "jp.softbank.mb.nfclockap"
    ...
    :cond_d
    const-string v3, "com.sec.nfc.felicalocktest"
    ...
    :cond_e
    const-string v3, "com.samsung.nfcfelicasettings"
    ...
    const-string v50, "android.uid.system"

    goto/16 :goto_2

    .restart local v39    # "nameError":Ljava/lang/String;
    :cond_f
...
.method public parsePackage(Ljava/io/File;I)Landroid/content/pm/PackageParser$Package;
    ...
    invoke-direct {p0, p1}, Landroid/content/pm/PackageParser;->getMonolithicApkPath(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p2}, Landroid/content/pm/PackageParser;->parseMonolithicPackage(Ljava/io/File;I)Landroid/content/pm/PackageParser$Package;
