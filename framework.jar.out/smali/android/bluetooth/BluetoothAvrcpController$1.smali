...
.method public onBluetoothStateChange(Z)V
    ...
    .prologue
    # getter for: Landroid/bluetooth/BluetoothAvrcpController;->DBG:Z
    invoke-static {}, Landroid/bluetooth/BluetoothAvrcpController;->access$000()Z
    ...
    invoke-static {v1}, Landroid/bluetooth/BluetoothAvrcpController;->access$100(Landroid/bluetooth/BluetoothAvrcpController;)Landroid/content/ServiceConnection;
    ...
    invoke-static {v1, v3}, Landroid/bluetooth/BluetoothAvrcpController;->access$202(Landroid/bluetooth/BluetoothAvrcpController;Landroid/bluetooth/IBluetoothAvrcpController;)Landroid/bluetooth/IBluetoothAvrcpController;

    iget-object v1, p0, Landroid/bluetooth/BluetoothAvrcpController$1;->this$0:Landroid/bluetooth/BluetoothAvrcpController;

    # getter for: Landroid/bluetooth/BluetoothAvrcpController;->mContext:Landroid/content/Context;
    invoke-static {v1}, Landroid/bluetooth/BluetoothAvrcpController;->access$300(Landroid/bluetooth/BluetoothAvrcpController;)Landroid/content/Context;
    ...
    # getter for: Landroid/bluetooth/BluetoothAvrcpController;->mConnection:Landroid/content/ServiceConnection;
    invoke-static {v3}, Landroid/bluetooth/BluetoothAvrcpController;->access$100(Landroid/bluetooth/BluetoothAvrcpController;)Landroid/content/ServiceConnection;
    ...
    invoke-static {v1}, Landroid/bluetooth/BluetoothAvrcpController;->access$200(Landroid/bluetooth/BluetoothAvrcpController;)Landroid/bluetooth/IBluetoothAvrcpController;
