...
.method public onBluetoothStateChange(Z)V
    ...
    # getter for: Landroid/bluetooth/BluetoothInputDevice;->VDBG:Z
    invoke-static {}, Landroid/bluetooth/BluetoothInputDevice;->access$100()Z
    ...
    invoke-static {v1}, Landroid/bluetooth/BluetoothInputDevice;->access$200(Landroid/bluetooth/BluetoothInputDevice;)Landroid/content/ServiceConnection;
    ...
    invoke-static {v1, v3}, Landroid/bluetooth/BluetoothInputDevice;->access$302(Landroid/bluetooth/BluetoothInputDevice;Landroid/bluetooth/IBluetoothInputDevice;)Landroid/bluetooth/IBluetoothInputDevice;

    iget-object v1, p0, Landroid/bluetooth/BluetoothInputDevice$1;->this$0:Landroid/bluetooth/BluetoothInputDevice;

    # getter for: Landroid/bluetooth/BluetoothInputDevice;->mContext:Landroid/content/Context;
    invoke-static {v1}, Landroid/bluetooth/BluetoothInputDevice;->access$400(Landroid/bluetooth/BluetoothInputDevice;)Landroid/content/Context;
    ...
    # getter for: Landroid/bluetooth/BluetoothInputDevice;->mConnection:Landroid/content/ServiceConnection;
    invoke-static {v3}, Landroid/bluetooth/BluetoothInputDevice;->access$200(Landroid/bluetooth/BluetoothInputDevice;)Landroid/content/ServiceConnection;
    ...
    invoke-static {v1}, Landroid/bluetooth/BluetoothInputDevice;->access$300(Landroid/bluetooth/BluetoothInputDevice;)Landroid/bluetooth/IBluetoothInputDevice;
