...
.field private static final VERSION:I = 0x20084

.field static final VERSION_SEC:I = 0x20000
...
.method public readHistoryDelta(Landroid/os/Parcel;Landroid/os/BatteryStats$HistoryItem;)V
    ...
    iput-byte v0, v1, Landroid/os/BatteryStats$HistoryItem;->batteryLevel:B

    shl-int/lit8 v17, v6, 0x7

    shr-int/lit8 v17, v17, 0x15
    ...
    iput-short v0, v1, Landroid/os/BatteryStats$HistoryItem;->batteryTemperature:S
    ...
    iput-char v0, v1, Landroid/os/BatteryStats$HistoryItem;->batteryVoltage:C
    ...
    shr-int/lit8 v17, v13, 0x10

    const v18, 0xffff

    and-int v16, v17, v18

    .local v16, "wakeReasonIndex":I
    const v17, 0xffff
    ...
    invoke-direct {v0, v15, v1}, Lcom/android/internal/os/BatteryStatsImpl;->readHistoryTag(ILandroid/os/BatteryStats$HistoryTag;)V
    ...
    .end local v13    # "indexes":I
    .end local v15    # "wakeLockIndex":I
    .end local v16    # "wakeReasonIndex":I
    :goto_7
    ...
    invoke-direct {v0, v12, v1}, Lcom/android/internal/os/BatteryStatsImpl;->readHistoryTag(ILandroid/os/BatteryStats$HistoryTag;)V
    ...
    .restart local v13    # "indexes":I
    .restart local v15    # "wakeLockIndex":I
    .restart local v16    # "wakeReasonIndex":I
    :cond_7
    const/16 v17, 0x0
...
.method setOnBatteryLocked(JJZII)V
    ...
    iget-object v5, v0, Lcom/android/internal/os/BatteryStatsImpl;->mKernelGpuSpeedReader:Lcom/android/internal/os/KernelGpuSpeedReader;

    invoke-virtual {v5}, Lcom/android/internal/os/KernelGpuSpeedReader;->readDelta()[J

    const-string v5, "BatteryStatsImpl"

    const-string v6, "charging plug is pulled!  mKernelGpuSpeedReader.readDelta "
    ...
    const-string v6, "charging plug is inserted!  noteGpuStoppedLocked"
...
.method public setPowerProfile(Lcom/android/internal/os/PowerProfile;)V
    ...
    const-string v6, "cpu.power.loadbase"
    ...
    const-string/jumbo v0, "time_in_load_state"

    .local v0, "cpuSpeedReaderFile":Ljava/lang/String;
    :goto_0
    iget-object v5, p0, Lcom/android/internal/os/BatteryStatsImpl;->mPowerProfile:Lcom/android/internal/os/PowerProfile;
    ...
    new-array v5, v3, [Lcom/android/internal/os/KernelCpuSpeedReader;

    iput-object v5, p0, Lcom/android/internal/os/BatteryStatsImpl;->mKernelCpuSpeedReaders:[Lcom/android/internal/os/KernelCpuSpeedReader;
    ...
    invoke-virtual {v5, v2}, Lcom/android/internal/os/PowerProfile;->getNumSpeedStepsInCpuCluster(I)I

    move-result v4

    .local v4, "numSpeedSteps":I
    iget-object v5, p0, Lcom/android/internal/os/BatteryStatsImpl;->mKernelCpuSpeedReaders:[Lcom/android/internal/os/KernelCpuSpeedReader;

    new-instance v6, Lcom/android/internal/os/KernelCpuSpeedReader;

    invoke-direct {v6, v1, v4, v0}, Lcom/android/internal/os/KernelCpuSpeedReader;-><init>(IILjava/lang/String;)V

    aput-object v6, v5, v2

    iget-object v5, p0, Lcom/android/internal/os/BatteryStatsImpl;->mPowerProfile:Lcom/android/internal/os/PowerProfile;

    invoke-virtual {v5, v2}, Lcom/android/internal/os/PowerProfile;->getNumCoresInCpuCluster(I)I
    ...
    .end local v0    # "cpuSpeedReaderFile":Ljava/lang/String;
    .end local v1    # "firstCpuOfCluster":I
    .end local v2    # "i":I
    .end local v3    # "numClusters":I
    .end local v4    # "numSpeedSteps":I
    :cond_0
    const-string/jumbo v0, "time_in_state"

    .restart local v0    # "cpuSpeedReaderFile":Ljava/lang/String;
    goto :goto_0

    .restart local v1    # "firstCpuOfCluster":I
    .restart local v2    # "i":I
    .restart local v3    # "numClusters":I
    :cond_1
    monitor-exit p0
...
.method public updateWifiStateLocked(Landroid/net/wifi/WifiActivityEnergyInfo;)V
    ...
    invoke-static {v5, v6, v15}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    goto :goto_0

    .end local v15    # "e":Ljava/io/IOException;
    :cond_2
    new-instance v34, Landroid/util/SparseLongArray;

    invoke-direct/range {v34 .. v34}, Landroid/util/SparseLongArray;-><init>()V

    .local v34, "rxPackets":Landroid/util/SparseLongArray;
    new-instance v56, Landroid/util/SparseLongArray;

    invoke-direct/range {v56 .. v56}, Landroid/util/SparseLongArray;-><init>()V

    .local v56, "txPackets":Landroid/util/SparseLongArray;
    const-wide/16 v50, 0x0

    .local v50, "totalTxPackets":J
    const-wide/16 v44, 0x0

    .local v44, "totalRxPackets":J
    if-eqz v14, :cond_5
    ...
    invoke-virtual {v14, v0, v5}, Landroid/net/NetworkStats;->getValues(ILandroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;
    ...
    .local v52, "totalWifiLockTimeMs":J
    const-wide/16 v46, 0x0

    .local v46, "totalScanTimeMs":J
    move-object/from16 v0, p0
    ...
    check-cast v57, Lcom/android/internal/os/BatteryStatsImpl$Uid;

    .local v57, "uid":Lcom/android/internal/os/BatteryStatsImpl$Uid;
    ...
    .end local v57    # "uid":Lcom/android/internal/os/BatteryStatsImpl$Uid;
    :cond_6
    const/16 v19, 0x0
    ...
    .restart local v57    # "uid":Lcom/android/internal/os/BatteryStatsImpl$Uid;
    move-object/from16 v0, v57
    ...
    .local v40, "scanTimeSinceMarkMs":J
    const-wide/16 v6, 0x0
    ...
    invoke-virtual {v5, v0, v1}, Lcom/android/internal/os/BatteryStatsImpl$StopwatchTimer;->setMark(J)V

    move-wide/from16 v38, v40

    .local v38, "scanRxTimeSinceMarkMs":J
    move-wide/from16 v42, v40

    .local v42, "scanTxTimeSinceMarkMs":J
    cmp-long v5, v46, v36
    ...
    .end local v38    # "scanRxTimeSinceMarkMs":J
    .end local v42    # "scanTxTimeSinceMarkMs":J
    :cond_9
    move-object/from16 v0, v57
    ...
    .local v62, "wifiLockTimeSinceMarkMs":J
    const-wide/16 v6, 0x0
    ...
    .end local v26    # "myIdleTimeMs":J
    :cond_a
    add-int/lit8 v19, v19, 0x1

    goto/16 :goto_4

    .end local v40    # "scanTimeSinceMarkMs":J
    .end local v57    # "uid":Lcom/android/internal/os/BatteryStatsImpl$Uid;
    .end local v62    # "wifiLockTimeSinceMarkMs":J
    :cond_b
    const/16 v19, 0x0

    :goto_5
    invoke-virtual/range {v56 .. v56}, Landroid/util/SparseLongArray;->size()I
    ...
    .end local v30    # "myTxTimeMs":J
    .end local v57    # "uid":Lcom/android/internal/os/BatteryStatsImpl$Uid;
    :cond_c
    const/16 v19, 0x0

    :goto_6
    invoke-virtual/range {v34 .. v34}, Landroid/util/SparseLongArray;->size()I
    ...
    invoke-virtual {v0, v5, v6}, Lcom/android/internal/os/BatteryStatsImpl;->getWifiControllerActivity(II)J
    ...
    invoke-virtual {v0, v5, v8}, Lcom/android/internal/os/BatteryStatsImpl;->getWifiControllerActivity(II)J
    ...
    .local v12, "currentWifiRunningTimeMs":J
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    invoke-virtual {v0, v6, v7, v5}, Lcom/android/internal/os/BatteryStatsImpl;->computeBatteryRealtime(JI)J
    ...
    .local v54, "totalWifiRunningTimeMs":J
    const-string v5, "BatteryStatsImpl"
    ...
    const-string v7, "!@ currentWifiRunningTimeMs : "
    ...
    const-string v7, " totalWifiRunningTimeMs :"
    ...
    const-string v7, " batteryRealtime :"
    ...
    .end local v32    # "opVolt":D
    :cond_f
    const-string v5, "BatteryStatsImpl"

    const-string v6, "!@ no addCountLocked"

    invoke-static {v5, v6}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    sget-boolean v5, Lcom/android/internal/os/BatteryStatsImpl;->SHIP_BUILD:Z

    if-eqz v5, :cond_10

    sget-boolean v5, Lcom/android/internal/os/BatteryStatsImpl;->ENG_MODE:Z
    ...
    const-string v6, "BatteryStatImpl Wifi exception"
...
.method public writeHistoryDelta(Landroid/os/Parcel;Landroid/os/BatteryStats$HistoryItem;Landroid/os/BatteryStats$HistoryItem;)V
    ...
    .local v18, "lastBatteryLevelInt":I
    move-object/from16 v0, p0
    ...
    .local v19, "lastCurrentNTemperatureInt":I
    move-object/from16 v0, p0
    ...
    .local v21, "lastTemperatureInt2":I
    ...
    .local v16, "includeStepDetails":I
    :goto_2
    if-nez v16, :cond_3
    ...
    .local v11, "computeStepDetails":Z
    :goto_3
    move-object/from16 v0, p0
    ...
    .local v9, "batteryLevelIntChanged":Z
    :goto_4
    if-eqz v9, :cond_4
    ...
    .end local v25    # "wakeLockIndex":I
    .end local v26    # "wakeReasonIndex":I
    :cond_13
    move-object/from16 v0, p2
    ...
    shl-int/lit8 v28, v17, 0x10

    or-int v10, v27, v28

    .local v10, "codeAndIndex":I
    move-object/from16 v0, p1

    invoke-virtual {v0, v10}, Landroid/os/Parcel;->writeInt(I)V

    .end local v10    # "codeAndIndex":I
    ...
    .end local v9    # "batteryLevelIntChanged":Z
    .end local v11    # "computeStepDetails":Z
    .end local v14    # "deltaTimeToken":I
    .end local v15    # "firstToken":I
    .end local v16    # "includeStepDetails":I
    .end local v22    # "state2IntChanged":Z
    .end local v23    # "stateInt":I
    .end local v24    # "stateIntChanged":Z
    :cond_17
    const-wide/32 v28, 0x3fffd
    ...
    .restart local v14    # "deltaTimeToken":I
    goto/16 :goto_1
    ...
    .restart local v15    # "firstToken":I
    :cond_19
    const/16 v16, 0x0

    goto/16 :goto_2

    .restart local v16    # "includeStepDetails":I
    :cond_1a
    const/4 v11, 0x0
    ...
    .restart local v11    # "computeStepDetails":Z
    :cond_1b
    const/4 v9, 0x0
    ...
    .restart local v4    # "CurrentNTemperatureInt":I
    .restart local v9    # "batteryLevelIntChanged":Z
    :cond_1c
    const/4 v5, 0x0
    ...
    .restart local v23    # "stateInt":I
    :cond_1e
    const/16 v24, 0x0

    goto/16 :goto_7

    .restart local v24    # "stateIntChanged":Z
    :cond_1f
    const/16 v22, 0x0

    goto/16 :goto_8

    .restart local v22    # "state2IntChanged":Z
    :cond_20
    move-object/from16 v0, p1
    ...
    .restart local v25    # "wakeLockIndex":I
    goto/16 :goto_a

    :cond_22
    const v26, 0xffff

    .restart local v26    # "wakeReasonIndex":I
    goto/16 :goto_b
